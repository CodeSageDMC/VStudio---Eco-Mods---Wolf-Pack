...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Chocolate")] // Defines the localized name of the Chocolate.
    [Weight(300)] // Defines how heavy the Chocolate is.

    [Ecopedia("Food", "CATEGORY", createAsSubPage: true)]
    [LocDescription("ITEM DESCRIPTION.")] //The tooltip description for the food Chocolate.
    ...
    public partial class ChocolateRecipe : RecipeFamily
    {
        public ChocolateRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CacaoButterItem), 15, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
                    new IngredientElement(typeof(CacaoPowderItem), 15, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
                    new IngredientElement(typeof(PowderedMilkItem), 5, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
                    new IngredientElement(typeof(PowderedSugarItem), 20, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
                    new IngredientElement(typeof(SaltItem), 1, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
                ...
                // to create.
                Chocolates: new List<CraftingElement>
                {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ChocolateRecipe), start: 5f, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));
