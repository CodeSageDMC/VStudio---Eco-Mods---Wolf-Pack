...
namespace Eco.Mods
{
    ...
    public static class WorldObjectOccupancy
    {
        ...
        public static void InitializePart5()
        {
            ...
            // DryingRackObject
            WorldObject.AddOccupancy<DryingRackObject>(new List<BlockOccupancy>()
            {
                new BlockOccupancy(new Vector3i(0, 0, 0)),
                new BlockOccupancy(new Vector3i(-1, 0, 0)),
                new BlockOccupancy(new Vector3i(0, 0, -1)),
            ...
            // DistilleryObject
            WorldObject.AddOccupancy<DistilleryObject>(new List<BlockOccupancy>()
            {
                new BlockOccupancy(new Vector3i(0, 0, 0)),
                new BlockOccupancy(new Vector3i(1, 0, 0)),
                new BlockOccupancy(new Vector3i(0, 0, 1)),
            ...
            // DrinksBarObject
            WorldObject.AddOccupancy<DrinksBarObject>(new List<BlockOccupancy>()
            {
                new BlockOccupancy(new Vector3i(0, 0, 0)),
                new BlockOccupancy(new Vector3i(1, 0, 0)),
                new BlockOccupancy(new Vector3i(0, 0, 1)),
            ...
            // AlcoholCaskObject
            WorldObject.AddOccupancy<AlcoholCaskObject>(new List<BlockOccupancy>()
            {
                new BlockOccupancy(new Vector3i(0, 0, 0)),
                new BlockOccupancy(new Vector3i(1, 0, 0)),
                new BlockOccupancy(new Vector3i(0, 0, 1)),
            ...
            // PileOfBarrelsObject
            WorldObject.AddOccupancy<PileOfBarrelsObject>(new List<BlockOccupancy>()
            {
                new BlockOccupancy(new Vector3i(0, 0, 0)),
                new BlockOccupancy(new Vector3i(1, 0, 0)),
                new BlockOccupancy(new Vector3i(0, 0, 1)),
