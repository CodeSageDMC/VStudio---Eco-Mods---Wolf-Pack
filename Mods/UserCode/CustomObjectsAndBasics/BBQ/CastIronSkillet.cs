...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "CastIronSkillet Item")]
    public partial class CastIronSkilletObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CastIronSkilletItem);
        public override LocString DisplayName => Localizer.DoStr("Cast iron skillet");
...
//////////////////////////////////////1X2X3//////////////////////////////////////
            ...
            AddOccupancy<CastIronSkilletObject>(BlockOccupancyList);
		} 
    ...
    [Serialized]
    [LocDisplayName("Cast iron skillet")]
    [LocDescription("A cast iron skillet for frying foods.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [Weight(500)]
	[MaxStackSize(200)]
    [AllowPluginModules(Tags = new[] { "AdvancedUpgrade" }, ItemTypes = new[] { typeof(CookingUpgradeItem) })]
    public partial class CastIronSkilletItem : WorldObjectItem<CastIronSkilletObject>, IPersistentData
    {
    ...
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "CastIronSkillet Item")]
    public partial class CastIronSkilletRecipe : RecipeFamily
    {
        public CastIronSkilletRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Castironskillet",  //noloc
                displayName: Localizer.DoStr("Cast iron skillet"),
                ...
                {
                    new CraftingElement<CastIronSkilletItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CastIronSkilletRecipe), start: 4, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));

            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cast iron skillet"), recipeType: typeof(CastIronSkilletRecipe));
            this.ModsPostInitialize();
