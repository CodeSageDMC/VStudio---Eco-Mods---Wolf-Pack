...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Drumstick")] // Defines the localized name of the item.
    ...
    public partial class DrumstickItem : FoodItem
    {

        /// <summary>The plural localization name for the food item.</summary>
        public override LocString DisplayNamePlural     => Localizer.DoStr("Drumstick");
