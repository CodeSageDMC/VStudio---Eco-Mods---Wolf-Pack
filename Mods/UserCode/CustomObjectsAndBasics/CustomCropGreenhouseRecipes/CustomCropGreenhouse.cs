...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "CustomCropGreenhouse Item")]
    public partial class CustomCropGreenhouseObject : WorldObject, IRepresentsItem, IHasInteractions
    {
        [Serialized] public bool OpenDoors { get; set; }
        public virtual Type RepresentedItemType => typeof(CustomCropGreenhouseItem);
        public override LocString DisplayName => Localizer.DoStr("Custom Crop Greenhouse");
        public override TableTextureMode TableTexture => TableTextureMode.Brick;
		static CustomCropGreenhouseObject() 
		{
...
//////////////////////////////////////5x5x13Back//////////////////////////////////////
            ...
            AddOccupancy<CustomCropGreenhouseObject>(BlockOccupancyList);
		} 
    ...
    [Serialized]
    [LocDisplayName("Custom Crop Greenhouse")]
    [LocDescription("Greenhouse for farming larger amounts of crops quickly.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [Tag("Crafting Table")]
    [Weight(5000)] // Defines how heavy CustomCropGreenhouse is.
	[MaxStackSize(200)]
    [AllowPluginModules(Tags = new[] { "BasicUpgrade" }, ItemTypes = new[] { typeof(FarmingUpgradeItem) })] //noloc
    public partial class CustomCropGreenhouseItem : WorldObjectItem<CustomCropGreenhouseObject>, IPersistentData
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CustomCropGreenhouse".</para>
    ...
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "CustomCropGreenhouse Item")]
    public partial class CustomCropGreenhouseRecipe : RecipeFamily
    {
        public CustomCropGreenhouseRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CustomCropGreenhouse",  //noloc
                displayName: Localizer.DoStr("Custom Crop Greenhouse"),
                ...
                {
                    new CraftingElement<CustomCropGreenhouseItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CustomCropGreenhouseRecipe), start: 10, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Custom Crop Greenhouse"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Custom Crop Greenhouse"), recipeType: typeof(CustomCropGreenhouseRecipe));
            this.ModsPostInitialize();
