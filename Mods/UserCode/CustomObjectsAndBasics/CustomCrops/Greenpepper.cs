...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Greenpepper" item. 
    ...
    [LocDisplayName("Greenpepper")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Greenpepper is.
    [Yield(typeof(GreenpepperItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A delicious Greenpepper grown in our custom crop greenhouse and hydroponics table.")] //The tooltip description for the food item.
    public partial class GreenpepperItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 4, Fat = 2, Protein = 0, Vitamins = 4};
