...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Cucumber" item. 
    ...
    [LocDisplayName("Cucumber")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Cucumber is.
    [Yield(typeof(CucumberItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A delicious Cucumber grown in our custom crop greenhouse and hydroponics table.")] //The tooltip description for the food item.
    public partial class CucumberItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 5, Fat = 2, Protein = 0, Vitamins = 4};
