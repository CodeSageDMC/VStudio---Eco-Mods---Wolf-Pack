...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Cocobean" item. 
    ...
    [LocDisplayName("Cacao Bean")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Cocobean is.
    [Yield(typeof(CocobeanItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A cacao bean grown in our custom crop greenhouse and hydroponics table.")] //The tooltip description for the food item.
    public partial class CocobeanItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 2, Fat = 3, Protein = 2, Vitamins = 4};
