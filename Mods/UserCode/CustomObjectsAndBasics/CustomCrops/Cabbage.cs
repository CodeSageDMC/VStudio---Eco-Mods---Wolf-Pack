...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Cabbage" item. 
    ...
    [LocDisplayName("Cabbage")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Cabbage is.
    [Yield(typeof(CabbageItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A delicious Cabbage grown in our custom crop greenhouse and hydroponics table.")] //The tooltip description for the food item.
    public partial class CabbageItem : FoodItem
    {
