...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Lime" item. 
    ...
    [LocDisplayName("Lime")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Lime is.
    [Yield(typeof(LimeItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A delicious Lime grown in our custom crop greenhouse and hydroponics table.")] //The tooltip description for the food item.
    public partial class LimeItem : FoodItem
    {
