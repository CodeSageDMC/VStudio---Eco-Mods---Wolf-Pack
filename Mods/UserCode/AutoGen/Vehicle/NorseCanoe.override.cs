...
namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Norse Canoe")]
    [LocDescription("A larger canoe for personal transport and medium sized loads.")]
    [IconGroup("World Object Minimap")]
    [Weight(16000)]
    [WaterPlaceable]
    [Ecopedia("Crafted Objects", "Vehicles", createAsSubPage: true)]
    public partial class NorseCanoeItem : WorldObjectItem<NorseCanoeObject>, IPersistentData
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "NorseCanoe".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Crafted Objects", "Vehicles", subPageName: "Norse Canoe Item")]
    public partial class NorseCanoeRecipe : Recipe
    {
        public NorseCanoeRecipe()
        {
            this.Init(
                name: "NorseCanoe",  //noloc
                displayName: Localizer.DoStr("Norse Canoe"),
                ...
                {
                    new CraftingElement<NorseCanoeItem>()
                });
            ...
            CraftingComponent.AddTagProduct(typeof(SmallShipyardObject), typeof(LargeCanoeRecipe), this);
        }
    ...
    [Ecopedia("Crafted Objects", "Vehicles", subPageName: "NorseCanoe Item")]
    public partial class NorseCanoeObject : PhysicsWorldObject, IRepresentsItem
    {
        static NorseCanoeObject()
        {
            WorldObject.AddOccupancy<NorseCanoeObject>(new List<BlockOccupancy>(0));
        }
        public override float InteractDistance => DefaultInteractDistance.WaterPlacement;
        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override bool PlacesBlocks            => false;
        public override LocString DisplayName { get { return Localizer.DoStr("Norse Canoe"); } }
        public Type RepresentedItemType { get { return typeof(NorseCanoeItem); } }

        private NorseCanoeObject() { }
        protected override void Initialize()
        {
            ...
            this.GetComponent<PublicStorageComponent>().Initialize(12, 21000000);
            ...
            this.ModsPostInitialize();
                ...
                this.GetComponent<PartsComponent>().Config(() => LocString.Empty, new PartInfo[]
                {
                                        ...
                                        new() { TypeName = nameof(WoodenOarItem), Quantity = 1},
                                    });
            }
        }
