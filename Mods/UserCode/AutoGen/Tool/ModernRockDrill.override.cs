...
namespace Eco.Mods.TechTree
{
        ...
        public ModernRockDrillRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(SteelGearItem), 4, typeof(BlacksmithSkill)),
                    new IngredientElement(typeof(SyntheticRubberItem), 4, typeof(BlacksmithSkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernRockDrillRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class ModernRockDrillItem : DrillItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(ModernRockDrillItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
        ...
        {
                yield return new() { Item = Item.Get("GasolineItem"), MaterialMult = 1 };
        yield return new() { Item = Item.Get("BiodieselItem"), MaterialMult = 1 };
        } }
    }
}
