...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronSickleRecipe : RecipeFamily
    {
        public IronSickleRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronSickleRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class IronSickleItem : SickleItem
    {
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronSickleItem), typeof(GatheringToolEfficiencyTalent)), CreateCalorieValue(20, typeof(FarmingSkill), typeof(IronSickleItem)));
        private static IDynamicValue exp                    = new ConstantValue(0.05f);
        private static IDynamicValue tier                   = new ConstantValue(2);
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(IronSickleItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
