...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelSickleRecipe : RecipeFamily
    {
        public SteelSickleRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelSickleRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class SteelSickleItem : SickleItem, IAoeToolItem
    {
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelSickleItem), typeof(GatheringToolEfficiencyTalent)), CreateCalorieValue(20, typeof(FarmingSkill), typeof(SteelSickleItem)));
        private static IDynamicValue exp                    = new ConstantValue(0.05f);
        private static IDynamicValue tier                   = new ConstantValue(3);
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(SteelSickleItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
