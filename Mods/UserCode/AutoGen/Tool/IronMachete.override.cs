...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronMacheteItem : MacheteItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(IronMacheteItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
