...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeBowRecipe : RecipeFamily
    {
        public CompositeBowRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(FiberglassItem), 20,typeof(HuntingSkill)),
    ...
    public partial class CompositeBowItem : BowItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, HuntingSkill.MultiplicativeStrategy, typeof(HuntingSkill), typeof(CompositeBowItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
