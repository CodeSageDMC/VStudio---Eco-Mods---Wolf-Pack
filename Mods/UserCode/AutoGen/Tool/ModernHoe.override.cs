...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernHoeRecipe : RecipeFamily
    {
        public ModernHoeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernHoeRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class ModernHoeItem : HoeItem, IAoeToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(ModernHoeItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
        ...
        public override float OriginalMaxDurability     => 3000f;
