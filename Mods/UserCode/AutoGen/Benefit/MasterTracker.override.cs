...
namespace Eco.Mods.TechTree
{
    ...
    public partial class HuntingMasterTrackerTalentGroup : TalentGroup
    {
        public HuntingMasterTrackerTalentGroup()
        {
            Talents = new Type[]
            {
                typeof(HuntingMasterTrackerTalent),
            };
    ...
    [Serialized]
    public partial class HuntingMasterTrackerTalent : MasterTrackerTalent
    {
        public override bool Base { get { return false; } }
        public override Type TalentGroupType { get { return typeof(HuntingMasterTrackerTalentGroup); } }
        public HuntingMasterTrackerTalent()
        {
            this.Value = 1;
        }
    }
