...
namespace Eco.Mods.TechTree
{
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Lavish Workspace: Artisan")]
    [LocDescription("Increases the tier requirement of tables by 0.2, but reduces the resources needed by 5 percent.(Only applies to claimed workstations)")]
    ...
    [Serialized]
    [LocDisplayName("Lavish Workspace: Hunting")]
    [LocDescription("Increases the tier requirement of tables by 0.2, but reduces the resources needed by 5 percent.(Only applies to claimed workstations)")]
    public partial class HuntingLavishWorkspaceTalentGroup : TalentGroup
    {
        public HuntingLavishWorkspaceTalentGroup()
        {
            Talents = new Type[]
            {
                typeof(HuntingLavishResourcesTalent),
                typeof(HuntingLavishReqTalent),
            };
    ...
    [Serialized]
    public partial class HuntingLavishResourcesTalent : LavishWorkspaceTalent
    {
        public override bool Base { get { return false; } }
        public override Type TalentGroupType { get { return typeof(HuntingLavishWorkspaceTalentGroup); } }
        public HuntingLavishResourcesTalent()
        {
            this.Value = 0.95f;
        }
    }
    [Serialized]
    public partial class HuntingLavishReqTalent : LavishWorkspaceTalent
    {
        public override bool Base { get { return false; } }
        public override Type TalentGroupType { get { return typeof(HuntingLavishWorkspaceTalentGroup); } }
        public HuntingLavishReqTalent()
        {
            this.Value = 0.2f;
        }
    }
