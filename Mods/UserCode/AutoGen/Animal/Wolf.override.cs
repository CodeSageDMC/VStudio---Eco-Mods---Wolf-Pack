...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side animal entity definition for "Wolf".</para>
    ...
    public class Wolf : AnimalEntity
    {
        ...
        /// <summary>
        /// <para>Server side species definition for "Wolf".</para>
        ...
        public class WolfSpecies : AnimalSpecies
        {
            public WolfSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Wolf); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "Wolf"; //noloc
                this.DisplayName = Localizer.DoStr("Wolf");
                this.DisplayDescription = Localizer.DoStr("A large, carnivorous canid with a distinctive howl, found in a variety of habitats around the world. They are a keystone species in many ecosystems, and are known for their social behavior and cooperative hunting strategies.");
                ...
                {
                    new SpeciesResource(typeof(WolfCarcassItem), new Range(1, 1)),
                };
