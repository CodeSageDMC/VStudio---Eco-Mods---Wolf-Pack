...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CriminiMushrooms" item. 
    ...
    [LocDisplayName("Crimini Mushrooms")] // Defines the localized name of the item.
    [Weight(75)] // Defines how heavy the CriminiMushrooms is.
    [Yield(typeof(CriminiMushroomsItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("Edible mushrooms that are quite tasty.")] //The tooltip description for the food item.
    public partial class CriminiMushroomsItem : FoodItem
    {
