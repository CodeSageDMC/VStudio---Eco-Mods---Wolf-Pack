...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BoleteMushrooms" item. 
    ...
    [LocDisplayName("Bolete Mushrooms")] // Defines the localized name of the item.
    [Weight(75)] // Defines how heavy the BoleteMushrooms is.
    [Yield(typeof(BoleteMushroomsItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("Boletus edulis.")] //The tooltip description for the food item.
