...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "AmanitaMushrooms" item. 
    ...
    [LocDisplayName("Amanita Mushrooms")] // Defines the localized name of the item.
    [Weight(75)] // Defines how heavy the AmanitaMushrooms is.
    ...
    [LocDescription("A potentially poisonous mushroom. It might not be wise to eat it raw, but it can be detoxified when prepared properly by a chef. Eat at your own risk!")] //The tooltip description for the food item.
