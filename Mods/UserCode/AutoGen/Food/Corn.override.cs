...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Corn" item. 
    ...
    [LocDisplayName("Corn")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Corn is.
    [Yield(typeof(CornItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A warmly colored kernel studded vegetable.")] //The tooltip description for the food item.
