...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CreosoteFlower" item. 
    ...
    [LocDisplayName("Creosote Flower")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CreosoteFlower is.
    [Yield(typeof(CreosoteFlowerItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    public partial class CreosoteFlowerItem : FoodItem
    {
