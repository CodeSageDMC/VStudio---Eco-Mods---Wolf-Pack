...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "PricklyPearFruit" item. 
    ...
    [LocDisplayName("Prickly Pear Fruit")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PricklyPearFruit is.
    [Yield(typeof(PricklyPearFruitItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A succulent fruit coated in a rather terrifying array of spines.")] //The tooltip description for the food item.
