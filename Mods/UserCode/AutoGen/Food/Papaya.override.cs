...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Papaya" item. 
    ...
    [LocDisplayName("Papaya")] // Defines the localized name of the item.
    [Weight(75)] // Defines how heavy the Papaya is.
    [Yield(typeof(PapayaItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("Nice fresh Papaya.")] //The tooltip description for the food item.
