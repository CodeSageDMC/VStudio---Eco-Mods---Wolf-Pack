...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Pumpkin" item. 
    ...
    [LocDisplayName("Pumpkin")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Pumpkin is.
    ...
    [LocDescription("Round and large.")] //The tooltip description for the food item.
    public partial class PumpkinItem : FoodItem
    {


        /// <summary>The amount of calories awarded for eating the food item.</summary>
        public override float Calories                  => 340;
