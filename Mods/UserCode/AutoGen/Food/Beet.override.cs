...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Beet")] // Defines the localized name of the item.
    [Weight(125)] // Defines how heavy the Beet is.
    [Yield(typeof(BeetItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A brilliantly colored bulb with an earthy sweetness.")] //The tooltip description for the food item.
