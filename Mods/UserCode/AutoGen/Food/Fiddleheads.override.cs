...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Fiddleheads" item. 
    ...
    [LocDisplayName("Fiddleheads")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the Fiddleheads is.
    [Yield(typeof(FiddleheadsItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A collection of the furled fronds of young ferns; a unique addition to a meal.")] //The tooltip description for the food item.
