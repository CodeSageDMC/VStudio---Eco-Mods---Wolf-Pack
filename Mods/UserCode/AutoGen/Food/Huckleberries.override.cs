...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Huckleberries" item. 
    ...
    [LocDisplayName("Huckleberries")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the Huckleberries is.
    [Yield(typeof(HuckleberriesItem), typeof(FarmingSkill), new float[] {1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f})]
    ...
    [LocDescription("A handfull of small wild berries. I'm your huckleberry.")] //The tooltip description for the food item.
