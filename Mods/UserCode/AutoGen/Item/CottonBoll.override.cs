...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "CottonBoll" item.</para>
    ...
    [LocDisplayName("Cotton Boll")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy CottonBoll is.
    [Yield(typeof(CottonBollItem), typeof(FarmingSkill), new float[] { 1f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f, 2.0f })]
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    [Tag("Crop")]
    [LocDescription("A fluffy round boll harvested from a cotton plant.")] //The tooltip description for the item.
