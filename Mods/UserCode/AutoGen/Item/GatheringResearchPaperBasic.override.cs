...
namespace Eco.Mods.TechTree
{
    ...
    public partial class GatheringResearchPaperBasicRecipe : RecipeFamily
    {
        public GatheringResearchPaperBasicRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Gathering Research Paper Basic"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(PlantFibersItem), 20, typeof(Skill)),
                    new IngredientElement("Raw Food", 30, typeof(Skill)), //noloc
                },
            ...
            this.Initialize(displayText: Localizer.DoStr("Gathering Research Paper Basic"), recipeType: typeof(GatheringResearchPaperBasicRecipe));
    ...
    [LocDisplayName("Gathering Research Paper Basic")] // Defines the localized name of the item.
