...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Saguaro Table Item")]
        [Tag(nameof(SurfaceTags.HasTableSurface))] 
    public partial class CompositeSaguaroTableObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeSaguaroTableItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Saguaro Table");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeSaguaroTableItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy CompositeSaguaroTable is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class CompositeSaguaroTableItem : WorldObjectItem<CompositeSaguaroTableObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeSaguaroTableObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeSaguaroTable".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Saguaro Table Item")]
    public partial class CompositeSaguaroTableRecipe : Recipe
    {
        public CompositeSaguaroTableRecipe()
        {
            this.Init(
                name: "CompositeSaguaroTable",  //noloc
                displayName: Localizer.DoStr("Composite Saguaro Table"),
