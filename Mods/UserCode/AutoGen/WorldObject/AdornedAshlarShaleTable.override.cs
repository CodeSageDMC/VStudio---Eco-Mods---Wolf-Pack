...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Shale Table Item")]
        [Tag(nameof(SurfaceTags.HasTableSurface))] 
    public partial class AdornedAshlarShaleTableObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AdornedAshlarShaleTableItem);
        public override LocString DisplayName => Localizer.DoStr("Adorned Ashlar Shale Table");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AdornedAshlarShaleTableItem.homeValue;
    ...
    public partial class AdornedAshlarShaleTableItem : WorldObjectItem<AdornedAshlarShaleTableObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(AdornedAshlarShaleTableObject).UILink(),
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Shale Table Item")]
    public partial class AdornedAshlarShaleTableRecipe : Recipe
    {
        public AdornedAshlarShaleTableRecipe()
        {
            this.Init(
                name: "AdornedAshlarShaleTable",  //noloc
                displayName: Localizer.DoStr("Adorned Ashlar Shale Table"),
