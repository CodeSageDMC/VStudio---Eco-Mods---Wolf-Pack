...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Office", subPageName: "Bookshelf Item")]
    public partial class BookshelfObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(BookshelfItem);
        public override LocString DisplayName => Localizer.DoStr("Bookshelf");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = BookshelfItem.homeValue;
    ...
    public partial class BookshelfItem : WorldObjectItem<BookshelfObject>
    {
        ...
        {
            ObjectName                              = typeof(BookshelfObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Bookshelf".</para>
    ...
    public partial class BookshelfRecipe : RecipeFamily
    {
        public BookshelfRecipe()
        {
            ...
            recipe.Init(
                name: "Bookshelf",  //noloc
                displayName: Localizer.DoStr("Bookshelf"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BookshelfRecipe), start: 2, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bookshelf"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bookshelf"), recipeType: typeof(BookshelfRecipe));
            this.ModsPostInitialize();
