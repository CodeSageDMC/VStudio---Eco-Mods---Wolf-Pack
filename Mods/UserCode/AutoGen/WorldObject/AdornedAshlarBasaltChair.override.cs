...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Basalt Chair Item")]
    public partial class AdornedAshlarBasaltChairObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AdornedAshlarBasaltChairItem);
        public override LocString DisplayName => Localizer.DoStr("Adorned Ashlar Basalt Chair");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AdornedAshlarBasaltChairItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Adorned Ashlar Basalt Chair")]
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy AdornedAshlarBasaltChair is.
		[Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class AdornedAshlarBasaltChairItem : WorldObjectItem<AdornedAshlarBasaltChairObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(AdornedAshlarBasaltChairObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdornedAshlarBasaltChair".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Basalt Chair Item")]
    public partial class AdornedAshlarBasaltChairRecipe : Recipe
    {
        public AdornedAshlarBasaltChairRecipe()
        {
            this.Init(
                name: "AdornedAshlarBasaltChair",  //noloc
                displayName: Localizer.DoStr("Adorned Ashlar Basalt Chair"),
                ...
                {
                    new CraftingElement<AdornedAshlarBasaltChairItem>()
                });
