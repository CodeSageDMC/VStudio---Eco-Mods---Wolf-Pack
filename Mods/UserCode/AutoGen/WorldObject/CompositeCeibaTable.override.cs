...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Ceiba Table Item")]
        [Tag(nameof(SurfaceTags.HasTableSurface))] 
    public partial class CompositeCeibaTableObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeCeibaTableItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Ceiba Table");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeCeibaTableItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy CompositeCeibaTable is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class CompositeCeibaTableItem : WorldObjectItem<CompositeCeibaTableObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeCeibaTableObject).UILink(),
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Ceiba Table Item")]
    public partial class CompositeCeibaTableRecipe : Recipe
    {
        public CompositeCeibaTableRecipe()
        {
            this.Init(
                name: "CompositeCeibaTable",  //noloc
                displayName: Localizer.DoStr("Composite Ceiba Table"),
