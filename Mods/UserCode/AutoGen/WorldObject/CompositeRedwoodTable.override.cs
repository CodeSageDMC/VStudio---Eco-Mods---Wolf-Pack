...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Redwood Table Item")]
        [Tag(nameof(SurfaceTags.HasTableSurface))] 
    public partial class CompositeRedwoodTableObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeRedwoodTableItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Redwood Table");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeRedwoodTableItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy CompositeRedwoodTable is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class CompositeRedwoodTableItem : WorldObjectItem<CompositeRedwoodTableObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeRedwoodTableObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeRedwoodTable".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Redwood Table Item")]
    public partial class CompositeRedwoodTableRecipe : Recipe
    {
        public CompositeRedwoodTableRecipe()
        {
            this.Init(
                name: "CompositeRedwoodTable",  //noloc
                displayName: Localizer.DoStr("Composite Redwood Table"),
