...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(2)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Large Festive Paper Lantern Item")]
    ...
    public partial class LargeFestivePaperLanternRecipe : RecipeFamily
    {
        public LargeFestivePaperLanternRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LargeFestivePaperLanternRecipe), start: 1, skillType: typeof(PaintingSkill), typeof(PaintingFocusedSpeedTalent), typeof(PaintingParallelSpeedTalent));
