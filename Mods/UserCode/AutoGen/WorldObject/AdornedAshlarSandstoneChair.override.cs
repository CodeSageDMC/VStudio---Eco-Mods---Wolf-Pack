...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Sandstone Chair Item")]
    public partial class AdornedAshlarSandstoneChairObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AdornedAshlarSandstoneChairItem);
        public override LocString DisplayName => Localizer.DoStr("Adorned Ashlar Sandstone Chair");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AdornedAshlarSandstoneChairItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Adorned Ashlar Sandstone Chair")]
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy AdornedAshlarSandstoneChair is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class AdornedAshlarSandstoneChairItem : WorldObjectItem<AdornedAshlarSandstoneChairObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(AdornedAshlarSandstoneChairObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdornedAshlarSandstoneChair".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Sandstone Chair Item")]
    public partial class AdornedAshlarSandstoneChairRecipe : Recipe
    {
        public AdornedAshlarSandstoneChairRecipe()
        {
            this.Init(
                name: "AdornedAshlarSandstoneChair",  //noloc
                displayName: Localizer.DoStr("Adorned Ashlar Sandstone Chair"),
                ...
                {
                    new CraftingElement<AdornedAshlarSandstoneChairItem>()
                });
