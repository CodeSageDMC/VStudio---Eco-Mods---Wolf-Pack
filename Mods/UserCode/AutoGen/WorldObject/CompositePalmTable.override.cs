...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Palm Table Item")]
        [Tag(nameof(SurfaceTags.HasTableSurface))] 
    public partial class CompositePalmTableObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositePalmTableItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Palm Table");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositePalmTableItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy CompositePalmTable is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class CompositePalmTableItem : WorldObjectItem<CompositePalmTableObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositePalmTableObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositePalmTable".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Palm Table Item")]
    public partial class CompositePalmTableRecipe : Recipe
    {
        public CompositePalmTableRecipe()
        {
            this.Init(
                name: "CompositePalmTable",  //noloc
                displayName: Localizer.DoStr("Composite Palm Table"),
