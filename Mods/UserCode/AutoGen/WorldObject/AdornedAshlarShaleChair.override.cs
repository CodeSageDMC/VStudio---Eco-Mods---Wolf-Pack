...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Shale Chair Item")]
    public partial class AdornedAshlarShaleChairObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AdornedAshlarShaleChairItem);
        public override LocString DisplayName => Localizer.DoStr("Adorned Ashlar Shale Chair");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AdornedAshlarShaleChairItem.homeValue;
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy AdornedAshlarShaleChair is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
    public partial class AdornedAshlarShaleChairItem : WorldObjectItem<AdornedAshlarShaleChairObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(AdornedAshlarShaleChairObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdornedAshlarShaleChair".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Adorned Ashlar Shale Chair Item")]
    public partial class AdornedAshlarShaleChairRecipe : Recipe
    {
        public AdornedAshlarShaleChairRecipe()
        {
            this.Init(
                name: "AdornedAshlarShaleChair",  //noloc
                displayName: Localizer.DoStr("Adorned Ashlar Shale Chair"),
