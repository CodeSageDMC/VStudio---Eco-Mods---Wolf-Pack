    ...
    public partial class CompostFertilizerRecipe : RecipeFamily
    {
        public CompostFertilizerRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CompostItem), 1, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CompostFertilizerRecipe), start: 0.3f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));
