...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Gasoline".</para>
    ...
    public partial class GasolineRecipe : RecipeFamily
    {
        public GasolineRecipe()
        {
            ...
            recipe.Init(
                name: "Gasoline",  //noloc
                displayName: Localizer.DoStr("Gasoline"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GasolineRecipe), start: 0.8f, skillType: typeof(OilDrillingSkill), typeof(OilDrillingFocusedSpeedTalent), typeof(OilDrillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Gasoline"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Gasoline"), recipeType: typeof(GasolineRecipe));
    ...
    [RequiresSkill(typeof(OilDrillingSkill), 2)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(GasolineItem); } }
    }
