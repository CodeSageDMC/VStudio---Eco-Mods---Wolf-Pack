...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Dining Room", subPageName: "Shelf Cabinet Item")]
    ...
    public partial class ShelfCabinetItem : WorldObjectItem<ShelfCabinetObject>
    {
        ...
        {
            ObjectName                              = typeof(ShelfCabinetObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ShelfCabinet".</para>
    ...
    public partial class ShelfCabinetRecipe : RecipeFamily
    {
        public ShelfCabinetRecipe()
        {
            ...
            recipe.Init(
                name: "ShelfCabinet",  //noloc
                displayName: Localizer.DoStr("Shelf Cabinet"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(PaperItem), 30, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ShelfCabinetRecipe), start: 2, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Shelf Cabinet"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Shelf Cabinet"), recipeType: typeof(ShelfCabinetRecipe));
            this.ModsPostInitialize();
