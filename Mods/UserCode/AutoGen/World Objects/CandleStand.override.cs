...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CandleStandRecipe : RecipeFamily
    {
        public CandleStandRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CandleStandRecipe), start: 4, skillType: typeof(BlacksmithSkill), typeof(BlacksmithFocusedSpeedTalent), typeof(BlacksmithParallelSpeedTalent));
