...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Rug Medium Item")]
    ...
    [LocDescription("A medium rug for medium uses.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy RugMedium is.
            public partial class RugMediumItem : WorldObjectItem<RugMediumObject>
    {
        ...
        {
            ObjectName                              = typeof(RugMediumObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RugMedium".</para>
    ...
    public partial class RugMediumRecipe : RecipeFamily
    {
        public RugMediumRecipe()
        {
            ...
            recipe.Init(
                name: "RugMedium",  //noloc
                displayName: Localizer.DoStr("Rug Medium"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RugMediumRecipe), start: 6, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Rug Medium"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Rug Medium"), recipeType: typeof(RugMediumRecipe));
            this.ModsPostInitialize();
