...
namespace Eco.Mods.TechTree
{
    ...
    public class TagDefinitions : IModInit
    {
        private static readonly TagDefinition[] Definitions =
        {
            ...
            new TagDefinition("Drinks")             { ShowInFilter = true, AutoHighlight = false, ShowInEcopedia = false },
            new TagDefinition("Wooden Barrel")             { ShowInFilter = true, AutoHighlight = false, ShowInEcopedia = false },
