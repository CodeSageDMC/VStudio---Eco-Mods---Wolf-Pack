...
namespace Eco.Mods.TechTree
{
    ...
    public abstract partial class ShovelItem : ToolItem, IInteractor
    {
        ...
        public override int MaxTake => 1000;
        ...
        [Interaction(InteractionTrigger.InteractKey, tags: BlockTags.Diggable, canHoldToTrigger: TriBool.True, animationDriven: false)]
        public bool DigFastwithE(Player player, InteractionTriggerInfo triggerInfo, InteractionTarget target)
        {
            // Fallback if not enough room in carrying stack
            var carry = player.User.Carrying;
            if (MaxTake > 0 && carry.Quantity >= MaxTake)
