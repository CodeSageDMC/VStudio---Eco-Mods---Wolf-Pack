...
public partial class PurpleKushBudRecipe : RecipeFamily
{
    public PurpleKushBudRecipe()
    {
        ...
        recipe.Init(
            ...
            displayName: Localizer.DoStr("Grow Purple Kush, Trim the Bud"),
        ...
        this.Initialize(displayText: Localizer.DoStr("Grow Purple Kush, Trim the Bud"), recipeType: typeof(PurpleKushBudRecipe));
