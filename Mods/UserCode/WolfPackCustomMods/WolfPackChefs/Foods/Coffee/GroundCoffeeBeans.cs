...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Ground Coffee Beans Item")]
    public partial class GroundCoffeeBeansRecipe : RecipeFamily
    {
        public GroundCoffeeBeansRecipe()
        {
            ...
            // type of the item, the amount of the item, the skill required, and the talent used.
                ...
                {
                         new IngredientElement(typeof(RoastedCoffeeBeansItem), 3, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GroundCoffeeBeansRecipe), start: 3f, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));
