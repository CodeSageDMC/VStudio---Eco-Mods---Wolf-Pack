    ...
    public partial class HydroWheatRecipe : RecipeFamily
    {
        public HydroWheatRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(WheatSeedItem), 4, typeof(FarmingSkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(HydroWheatRecipe), start: 10f, skillType: typeof(FarmingSkill));
