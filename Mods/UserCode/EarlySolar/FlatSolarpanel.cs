...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Crafted Objects", "Power Generation", subPageName: "FlatSolarpanel Item")]
    public partial class FlatSolarpanelObject : WorldObject, IRepresentsItem
    {
	  static FlatSolarpanelObject()
        {
			...
			AddOccupancy<FlatSolarpanelObject>(BlockOccupancyList);
        ...
        public virtual Type RepresentedItemType => typeof(FlatSolarpanelItem);
        public override LocString DisplayName => Localizer.DoStr("Flat Solar panel");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = FlatSolarpanelItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Flat Solar panel")]
    ...
    public partial class FlatSolarpanelItem : WorldObjectItem<FlatSolarpanelObject>
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FlatSolarpanel".</para>
    ...
    [Ecopedia("Crafted Objects", "Power Generation", subPageName: "FlatSolarpanel Item")]
    public partial class FlatSolarpanelRecipe : RecipeFamily
    {
        public FlatSolarpanelRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "FlatSolarpanel",  //noloc
                displayName: Localizer.DoStr("Flat Solar panel"),
                ...
                {
                    new CraftingElement<FlatSolarpanelItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FlatSolarpanelRecipe), start: 6, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Flat Solar panel"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Flat Solar panel"), recipeType: typeof(FlatSolarpanelRecipe));
            this.ModsPostInitialize();
