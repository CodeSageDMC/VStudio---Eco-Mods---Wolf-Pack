    ...
    public partial class DryTailings : RecipeFamily
    {
        public DryTailings()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Dry Tailings",
                    Localizer.DoStr("Dry Tailings"),
                    new IngredientElement[]
                    {
                    new IngredientElement(typeof(WetTailingsItem), 1, typeof(PotterySkill), typeof(PotteryLavishResourcesTalent)), 
                    },
                    new CraftingElement[]
                    {
                    new CraftingElement<TailingsItem>(),
                    }
                )
            };
        ...
        //    this.CraftMinutes = CreateCraftTimeValue(typeof(DryTailings), 0.5f, typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));     
            ...
            this.Initialize(Localizer.DoStr("Dry Tailings"), typeof(DryTailings));
