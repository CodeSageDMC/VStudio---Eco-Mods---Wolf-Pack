...
namespace Eco.Mods.TechTree
{
    ...
    public partial class Clay1 : RecipeFamily
    {
        public Clay1()
        {
        ...
        //    this.CraftMinutes = CreateCraftTimeValue(typeof(Clay1), 0.5f, typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));     
            this.CraftMinutes = CreateCraftTimeValue(typeof(Clay1), 0.25f, typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));     
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Clay"), typeof(Clay1));
