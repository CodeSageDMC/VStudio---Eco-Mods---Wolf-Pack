    ...
    public partial class AcornBulkRecipe : RecipeFamily
    {
        public AcornBulkRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(OakLogItem), 20, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),	// 4 x 10
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AcornBulkRecipe), start: 10, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));	// 2 x 10
