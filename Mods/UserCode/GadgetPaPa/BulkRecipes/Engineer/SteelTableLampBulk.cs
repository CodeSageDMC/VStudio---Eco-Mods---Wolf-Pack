...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Table Lamp Item Small Bulk")]
    public partial class SteelTableLampBulkRecipe : RecipeFamily
    {
        public SteelTableLampBulkRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelTableLampSmallBulk",  //noloc
                displayName: Localizer.DoStr("Steel Table Lamp Small Bulk"),
                ...
                {
                    new CraftingElement<SteelTableLampItem>(1f*BulkRecipeSettings.SmallBulkMultiplier*BulkRecipeSettings.SmallBulkOutput)	// 1 x 10 x 2
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelTableLampBulkRecipe), start: 4f*BulkRecipeSettings.SmallBulkMultiplier*BulkRecipeSettings.SmallBulkCraft, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));	// 4 x 10
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steel Table Lamp Small Bulk"), recipeType: typeof(SteelTableLampBulkRecipe));
