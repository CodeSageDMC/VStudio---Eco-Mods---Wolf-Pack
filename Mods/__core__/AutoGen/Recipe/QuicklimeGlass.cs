...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "QuicklimeGlass".</para>
    ...
    public partial class QuicklimeGlassRecipe : RecipeFamily
    {
        public QuicklimeGlassRecipe()
        {
            ...
            recipe.Init(
                name: "QuicklimeGlass",  //noloc
                displayName: Localizer.DoStr("Quicklime Glass"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(QuicklimeGlassRecipe), start: 1, skillType: typeof(GlassworkingSkill), typeof(GlassworkingFocusedSpeedTalent), typeof(GlassworkingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Quicklime Glass"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Quicklime Glass"), recipeType: typeof(QuicklimeGlassRecipe));
