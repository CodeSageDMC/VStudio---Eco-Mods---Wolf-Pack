...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherSmallAnimalRecipe : RecipeFamily
    {
        public ButcherSmallAnimalRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherSmallAnimalRecipe), start: 1, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
