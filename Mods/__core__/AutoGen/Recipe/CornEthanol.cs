...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CornEthanolRecipe : RecipeFamily
    {
        public CornEthanolRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CornEthanolRecipe), start: 1, skillType: typeof(CuttingEdgeCookingSkill), typeof(CuttingEdgeCookingFocusedSpeedTalent), typeof(CuttingEdgeCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Corn Ethanol"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Corn Ethanol"), recipeType: typeof(CornEthanolRecipe));
