...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ExoticFruitSalad".</para>
    ...
    public partial class ExoticFruitSaladRecipe : RecipeFamily
    {
        public ExoticFruitSaladRecipe()
        {
            ...
            recipe.Init(
                name: "ExoticFruitSalad",  //noloc
                displayName: Localizer.DoStr("Exotic Fruit Salad"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ExoticFruitSaladRecipe), start: 4, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Exotic Fruit Salad"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Exotic Fruit Salad"), recipeType: typeof(ExoticFruitSaladRecipe));
