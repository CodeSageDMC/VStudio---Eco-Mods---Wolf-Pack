...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FishOil".</para>
    ...
    public partial class FishOilRecipe : RecipeFamily
    {
        public FishOilRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(RawFishItem), 6, typeof(MillingSkill), typeof(MillingLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FishOilRecipe), start: 1, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));
