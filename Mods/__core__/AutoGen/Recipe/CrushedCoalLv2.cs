...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedCoalLv2".</para>
    ...
    public partial class CrushedCoalLv2Recipe : RecipeFamily
    {
        public CrushedCoalLv2Recipe()
        {
            ...
            recipe.Init(
                name: "CrushedCoalLv2",  //noloc
                displayName: Localizer.DoStr("Crushed Coal Lv2"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedCoalLv2Recipe), start: 1, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Coal Lv2"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Coal Lv2"), recipeType: typeof(CrushedCoalLv2Recipe));
