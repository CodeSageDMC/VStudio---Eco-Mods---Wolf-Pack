...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MixedVegetableMedley".</para>
    ...
    public partial class MixedVegetableMedleyRecipe : RecipeFamily
    {
        public MixedVegetableMedleyRecipe()
        {
            ...
            recipe.Init(
                name: "MixedVegetableMedley",  //noloc
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MixedVegetableMedleyRecipe), start: 0.8f, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Mixed Vegetable Medley"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Mixed Vegetable Medley"), recipeType: typeof(MixedVegetableMedleyRecipe));
