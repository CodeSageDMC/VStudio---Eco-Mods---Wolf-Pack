...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FishStew".</para>
    ...
    public partial class FishStewRecipe : RecipeFamily
    {
        public FishStewRecipe()
        {
            ...
            recipe.Init(
                name: "FishStew",  //noloc
                displayName: Localizer.DoStr("Fish Stew"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FishStewRecipe), start: 1, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fish Stew"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fish Stew"), recipeType: typeof(FishStewRecipe));
