...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ShaleBrick".</para>
    ...
    public partial class ShaleBrickRecipe : RecipeFamily
    {
        public ShaleBrickRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ShaleBrickRecipe), start: 1, skillType: typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Shale Brick"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Shale Brick"), recipeType: typeof(ShaleBrickRecipe));
