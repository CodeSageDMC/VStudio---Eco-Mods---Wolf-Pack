...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "GeologyResearchPaperModernGlass".</para>
    ...
    {
        public GeologyResearchPaperModernGlassRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GeologyResearchPaperModernGlassRecipe), start: 1, skillType: typeof(GlassworkingSkill), typeof(GlassworkingFocusedSpeedTalent), typeof(GlassworkingParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Geology Research Paper Modern Glass"), recipeType: typeof(GeologyResearchPaperModernGlassRecipe));
