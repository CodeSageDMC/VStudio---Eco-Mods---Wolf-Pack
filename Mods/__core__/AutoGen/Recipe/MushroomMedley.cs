...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MushroomMedley".</para>
    ...
    public partial class MushroomMedleyRecipe : RecipeFamily
    {
        public MushroomMedleyRecipe()
        {
            ...
            recipe.Init(
                name: "MushroomMedley",  //noloc
                displayName: Localizer.DoStr("Mushroom Medley"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MushroomMedleyRecipe), start: 0.8f, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Mushroom Medley"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Mushroom Medley"), recipeType: typeof(MushroomMedleyRecipe));
