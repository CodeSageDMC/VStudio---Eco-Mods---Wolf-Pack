...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherHareRecipe : RecipeFamily
    {
        public ButcherHareRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherHareRecipe), start: 0.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
