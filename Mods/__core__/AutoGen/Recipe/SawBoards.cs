...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SawBoards".</para>
    ...
    public partial class SawBoardsRecipe : RecipeFamily
    {
        public SawBoardsRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SawBoardsRecipe), start: 0.16f, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Saw Boards"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Saw Boards"), recipeType: typeof(SawBoardsRecipe));
