...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CharredMortar".</para>
    ...
    public partial class CharredMortarRecipe : RecipeFamily
    {
        public CharredMortarRecipe()
        {
            ...
            recipe.Init(
                name: "CharredMortar",  //noloc
                displayName: Localizer.DoStr("Charred Mortar"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("NaturalFiber", 5, true), //noloc
                },
            ...
            this.Initialize(displayText: Localizer.DoStr("Charred Mortar"), recipeType: typeof(CharredMortarRecipe));
