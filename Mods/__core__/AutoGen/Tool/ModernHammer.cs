...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernHammerRecipe : RecipeFamily
    {
        public ModernHammerRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernHammerRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class ModernHammerItem : HammerItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(ModernHammerItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
