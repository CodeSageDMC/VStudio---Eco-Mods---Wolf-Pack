...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelPickaxeItem : PickaxeItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(SteelPickaxeItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
