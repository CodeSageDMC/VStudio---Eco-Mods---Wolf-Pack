...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernAxeItem : AxeItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(ModernAxeItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
