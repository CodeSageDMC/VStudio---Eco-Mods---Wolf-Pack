...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelAxeItem : AxeItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(SteelAxeItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
