...
namespace Eco.Mods.TechTree
{
    ...
    public partial class StoneRoadToolRecipe : RecipeFamily
    {
        public StoneRoadToolRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("Wood", 8, typeof(BasicEngineeringSkill)), //noloc
                    new IngredientElement("Rock", 20, typeof(BasicEngineeringSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(StoneRoadToolRecipe), start: 0.5f, skillType: typeof(BasicEngineeringSkill));
    ...
    public partial class StoneRoadToolItem : RoadToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BasicEngineeringSkill.MultiplicativeStrategy, typeof(BasicEngineeringSkill), typeof(StoneRoadToolItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
