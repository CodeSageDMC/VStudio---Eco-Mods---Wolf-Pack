...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ChainsawItem : AxeItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(ChainsawItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
