...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelHoeItem : HoeItem, IAoeToolItem
    {
        ...
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(SteelHoeItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
