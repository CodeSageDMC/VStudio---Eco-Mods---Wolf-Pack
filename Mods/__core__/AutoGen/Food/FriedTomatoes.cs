...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "FriedTomatoes" item. 
    ...
    [LocDisplayName("Fried Tomatoes")] // Defines the localized name of the item.
    [Weight(200)] // Defines how heavy the FriedTomatoes is.
    [Tag("FriedVegetable")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FriedTomatoes".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Fried Tomatoes Item")]
    public partial class FriedTomatoesRecipe : RecipeFamily
    {
        public FriedTomatoesRecipe()
        {
            ...
            recipe.Init(
                name: "FriedTomatoes",  //noloc
                displayName: Localizer.DoStr("Fried Tomatoes"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FriedTomatoesRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fried Tomatoes"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fried Tomatoes"), recipeType: typeof(FriedTomatoesRecipe));
