...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Cornmeal" item. 
    ...
    [LocDisplayName("Cornmeal")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Cornmeal is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Dried and ground corn; it's like a courser flour.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Cornmeal".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Cornmeal Item")]
    public partial class CornmealRecipe : RecipeFamily
    {
        public CornmealRecipe()
        {
            ...
            recipe.Init(
                name: "Cornmeal",  //noloc
                displayName: Localizer.DoStr("Cornmeal"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CornmealRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cornmeal"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cornmeal"), recipeType: typeof(CornmealRecipe));
