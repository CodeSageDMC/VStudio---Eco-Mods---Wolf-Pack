...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "PastryDough" item. 
    ...
    [Weight(100)] // Defines how heavy the PastryDough is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("An extra fatty leavened dough for making yummy pastries.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PastryDough".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Pastry Dough Item")]
    public partial class PastryDoughRecipe : RecipeFamily
    {
        public PastryDoughRecipe()
        {
            ...
            recipe.Init(
                name: "PastryDough",  //noloc
                displayName: Localizer.DoStr("Pastry Dough"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PastryDoughRecipe), start: 0.4f, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pastry Dough"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pastry Dough"), recipeType: typeof(PastryDoughRecipe));
