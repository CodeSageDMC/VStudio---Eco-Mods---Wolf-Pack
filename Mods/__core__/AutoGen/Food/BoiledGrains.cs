...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BoiledGrains" item. 
    ...
    [LocDisplayName("Boiled Grains")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the BoiledGrains is.
    [Ecopedia("Food", "Charred Food", createAsSubPage: true)]
    [LocDescription("A dish of plain boiled grains that can be topped with fruit to make a nice tasting porridge.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BoiledGrains".</para>
    ...
    [Ecopedia("Food", "Charred Food", subPageName: "Boiled Grains Item")]
    public partial class BoiledGrainsRecipe : RecipeFamily
    {
        public BoiledGrainsRecipe()
        {
            ...
            recipe.Init(
                name: "BoiledGrains",  //noloc
                displayName: Localizer.DoStr("Boiled Grains"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Grain", 1, true), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiledGrainsRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Boiled Grains"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Boiled Grains"), recipeType: typeof(BoiledGrainsRecipe));
