...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "SmoothGutNoodleRoll" item. 
    ...
    [LocDescription("These noodle rolls look VERY smooth.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmoothGutNoodleRoll".</para>
    ...
    public partial class SmoothGutNoodleRollRecipe : RecipeFamily
    {
        public SmoothGutNoodleRollRecipe()
        {
            ...
            recipe.Init(
                name: "SmoothGutNoodleRoll",  //noloc
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SmoothGutNoodleRollRecipe), start: 3, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Smooth Gut Noodle Roll"), recipeType: typeof(SmoothGutNoodleRollRecipe));
