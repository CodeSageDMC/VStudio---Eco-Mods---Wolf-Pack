...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("A basic yet filling meal with a bite.")] //The tooltip description for the food item.
    public partial class PokeBowlItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 21, Fat = 11, Protein = 10, Vitamins = 7};
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Poke Bowl Item")]
        ...
        public PokeBowlRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(BeansItem), 4, typeof(AdvancedCookingSkill), typeof(AdvancedCookingLavishResourcesTalent)),
