...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Flour" item. 
    ...
    [LocDisplayName("Flour")] // Defines the localized name of the item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Flour".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Flour Item")]
    public partial class FlourRecipe : RecipeFamily
    {
        public FlourRecipe()
        {
            ...
            recipe.Init(
                name: "Flour",  //noloc
                displayName: Localizer.DoStr("Flour"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FlourRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Flour"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Flour"), recipeType: typeof(FlourRecipe));
