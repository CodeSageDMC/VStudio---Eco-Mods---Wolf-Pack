...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawRoastRecipe : RecipeFamily
    {
        public RawRoastRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawRoastRecipe), start: 0.8f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
