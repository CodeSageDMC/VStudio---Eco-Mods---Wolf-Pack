...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "ToppedPorridge" item. 
    ...
    [LocDisplayName("Topped Porridge")] // Defines the localized name of the item.
    [Weight(200)] // Defines how heavy the ToppedPorridge is.
    [Ecopedia("Food", "Campfire", createAsSubPage: true)]
    [LocDescription("A thick gruel of boiled grains with a dash of fruity flavor.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ToppedPorridge".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Topped Porridge Item")]
    public partial class ToppedPorridgeRecipe : RecipeFamily
    {
        public ToppedPorridgeRecipe()
        {
            ...
            recipe.Init(
                name: "ToppedPorridge",  //noloc
                displayName: Localizer.DoStr("Topped Porridge"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ToppedPorridgeRecipe), start: 1, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Topped Porridge"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Topped Porridge"), recipeType: typeof(ToppedPorridgeRecipe));
