...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "RootCampfireStew" item. 
    ...
    [LocDisplayName("Root Campfire Stew")] // Defines the localized name of the item.
    [Weight(500)] // Defines how heavy the RootCampfireStew is.
    ...
    public partial class RootCampfireStewItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 8, Fat = 12, Protein = 5, Vitamins = 5};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RootCampfireStew".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Root Campfire Stew Item")]
    public partial class RootCampfireStewRecipe : RecipeFamily
    {
        public RootCampfireStewRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "RootCampfireStew",  //noloc
                displayName: Localizer.DoStr("Root Campfire Stew"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RootCampfireStewRecipe), start: 1, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Root Campfire Stew"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Root Campfire Stew"), recipeType: typeof(RootCampfireStewRecipe));
