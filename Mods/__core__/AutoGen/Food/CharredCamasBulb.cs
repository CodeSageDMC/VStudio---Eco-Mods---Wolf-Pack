...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CharredCamasBulb" item. 
    ...
    [LocDescription("A fibrous and sweet treat much like a sweet potato, though slightly blackened over the heat of a campfire.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CharredCamasBulb".</para>
    ...
    [Ecopedia("Food", "Charred Food", subPageName: "Charred Camas Bulb Item")]
    public partial class CharredCamasBulbRecipe : RecipeFamily
    {
        public CharredCamasBulbRecipe()
        {
            ...
            recipe.Init(
                name: "CharredCamasBulb",  //noloc
                displayName: Localizer.DoStr("Charred Camas Bulb"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CharredCamasBulbRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Charred Camas Bulb"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Charred Camas Bulb"), recipeType: typeof(CharredCamasBulbRecipe));
