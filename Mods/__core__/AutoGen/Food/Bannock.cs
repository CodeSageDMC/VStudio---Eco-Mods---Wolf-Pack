...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("A dense whole wheat unleavened bread.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Bannock".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Bannock Item")]
    public partial class BannockRecipe : RecipeFamily
    {
        public BannockRecipe()
        {
            ...
            recipe.Init(
                name: "Bannock",  //noloc
                displayName: Localizer.DoStr("Bannock"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BannockRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bannock"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bannock"), recipeType: typeof(BannockRecipe));
