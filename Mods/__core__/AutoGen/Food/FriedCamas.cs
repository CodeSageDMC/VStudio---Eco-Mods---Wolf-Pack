...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "FriedCamas" item. 
    ...
    [LocDescription("Deep fried Camas. Bit greasy.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FriedCamas".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Fried Camas Item")]
    public partial class FriedCamasRecipe : RecipeFamily
    {
        public FriedCamasRecipe()
        {
            ...
            recipe.Init(
                name: "FriedCamas",  //noloc
                displayName: Localizer.DoStr("Fried Camas"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FriedCamasRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fried Camas"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fried Camas"), recipeType: typeof(FriedCamasRecipe));
