...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "InfusedOil" item. 
    ...
    [LocDisplayName("Infused Oil")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the InfusedOil is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Oil infused with flavor to enhance it.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "InfusedOil".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Infused Oil Item")]
    public partial class InfusedOilRecipe : RecipeFamily
    {
        public InfusedOilRecipe()
        {
            ...
            recipe.Init(
                name: "InfusedOil",  //noloc
                displayName: Localizer.DoStr("Infused Oil"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(InfusedOilRecipe), start: 1, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Infused Oil"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Infused Oil"), recipeType: typeof(InfusedOilRecipe));
