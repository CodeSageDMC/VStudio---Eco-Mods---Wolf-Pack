...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Oil")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Oil is.
    [Fuel(4000)][Tag("Fuel")] // Marks the Oil as fuel item.
    [Tag("Fat")]
    [Tag("Oil")]
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("A plant fat extracted for use in cooking.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Oil".</para>
    ...
    public partial class OilRecipe : RecipeFamily
    {
        public OilRecipe()
        {
            ...
            recipe.Init(
                name: "Oil",  //noloc
                displayName: Localizer.DoStr("Oil"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(CerealGermItem), 8, typeof(MillingSkill), typeof(MillingLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(OilRecipe), start: 1, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Oil"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Oil"), recipeType: typeof(OilRecipe));
