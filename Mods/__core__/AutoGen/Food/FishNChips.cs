...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Deep-fried fish served with a side of taro chips.")] //The tooltip description for the food item.
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Fish N Chips Item")]
