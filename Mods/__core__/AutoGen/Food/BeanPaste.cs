...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BeanPaste" item. 
    ...
    [LocDisplayName("Bean Paste")] // Defines the localized name of the item.
    [Weight(200)] // Defines how heavy the BeanPaste is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Smashed beans can work as a thickener or flavour enhancer.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BeanPaste".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Bean Paste Item")]
    public partial class BeanPasteRecipe : RecipeFamily
    {
        public BeanPasteRecipe()
        {
            ...
            recipe.Init(
                name: "BeanPaste",  //noloc
                displayName: Localizer.DoStr("Bean Paste"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BeanPasteRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bean Paste"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bean Paste"), recipeType: typeof(BeanPasteRecipe));
