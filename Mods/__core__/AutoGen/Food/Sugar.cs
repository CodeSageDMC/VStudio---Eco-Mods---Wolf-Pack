...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Sugar" item. 
    ...
    [LocDisplayName("Sugar")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Sugar is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Even sweet lovers don't eat sugar plain.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Sugar".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Sugar Item")]
    public partial class SugarRecipe : RecipeFamily
    {
        public SugarRecipe()
        {
            ...
            recipe.Init(
                name: "Sugar",  //noloc
                displayName: Localizer.DoStr("Sugar"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SugarRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Sugar"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Sugar"), recipeType: typeof(SugarRecipe));
