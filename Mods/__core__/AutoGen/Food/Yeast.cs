...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Yeast" item. 
    ...
    [LocDisplayName("Yeast")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Yeast is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("A fungus that acts as an amazing leavening agent.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Yeast".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Yeast Item")]
    public partial class YeastRecipe : RecipeFamily
    {
        public YeastRecipe()
        {
            ...
            recipe.Init(
                name: "Yeast",  //noloc
                displayName: Localizer.DoStr("Yeast"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(YeastRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Yeast"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Yeast"), recipeType: typeof(YeastRecipe));
