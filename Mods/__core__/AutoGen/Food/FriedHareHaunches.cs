...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "FriedHareHaunches" item. 
    ...
    [LocDisplayName("Fried Hare Haunches")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the FriedHareHaunches is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Everything is better deep fried.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FriedHareHaunches".</para>
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Fried Hare Haunches Item")]
    public partial class FriedHareHaunchesRecipe : RecipeFamily
    {
        public FriedHareHaunchesRecipe()
        {
            ...
            recipe.Init(
                name: "FriedHareHaunches",  //noloc
                displayName: Localizer.DoStr("Fried Hare Haunches"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FriedHareHaunchesRecipe), start: 2, skillType: typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fried Hare Haunches"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fried Hare Haunches"), recipeType: typeof(FriedHareHaunchesRecipe));
