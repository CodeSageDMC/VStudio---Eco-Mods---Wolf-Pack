...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CharredAgave" item. 
    ...
    [LocDisplayName("Charred Agave")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the CharredAgave is.
    [Tag("CharredGreen")]
    [Ecopedia("Food", "Charred Food", createAsSubPage: true)]
    [LocDescription("Agave leaves that have been charred over a campfire.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CharredAgave".</para>
    ...
    [Ecopedia("Food", "Charred Food", subPageName: "Charred Agave Item")]
    public partial class CharredAgaveRecipe : RecipeFamily
    {
        public CharredAgaveRecipe()
        {
            ...
            recipe.Init(
                name: "CharredAgave",  //noloc
                displayName: Localizer.DoStr("Charred Agave"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CharredAgaveRecipe), start: 0.5f, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Charred Agave"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Charred Agave"), recipeType: typeof(CharredAgaveRecipe));
