...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "HuckleberryPie" item. 
    ...
    [LocDisplayName("Huckleberry Pie")] // Defines the localized name of the item.
    [Weight(600)] // Defines how heavy the HuckleberryPie is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("A fantastic combination of flaky crust and scrumptious berries.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "HuckleberryPie".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Huckleberry Pie Item")]
    public partial class HuckleberryPieRecipe : RecipeFamily
    {
        public HuckleberryPieRecipe()
        {
            ...
            recipe.Init(
                name: "HuckleberryPie",  //noloc
                displayName: Localizer.DoStr("Huckleberry Pie"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(HuckleberryPieRecipe), start: 2, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Huckleberry Pie"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Huckleberry Pie"), recipeType: typeof(HuckleberryPieRecipe));
