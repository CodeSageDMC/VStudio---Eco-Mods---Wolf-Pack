...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawSausageRecipe : RecipeFamily
    {
        public RawSausageRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawSausageRecipe), start: 0.8f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
