...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "FieldCampfireStew" item. 
    ...
    [LocDisplayName("Field Campfire Stew")] // Defines the localized name of the item.
    [Weight(500)] // Defines how heavy the FieldCampfireStew is.
    ...
    public partial class FieldCampfireStewItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 14, Fat = 8, Protein = 4, Vitamins = 4};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FieldCampfireStew".</para>
    ...
    [Ecopedia("Food", "Campfire", subPageName: "Field Campfire Stew Item")]
    public partial class FieldCampfireStewRecipe : RecipeFamily
    {
        public FieldCampfireStewRecipe()
        {
            ...
            recipe.Init(
                name: "FieldCampfireStew",  //noloc
                displayName: Localizer.DoStr("Field Campfire Stew"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FieldCampfireStewRecipe), start: 1, skillType: typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Field Campfire Stew"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Field Campfire Stew"), recipeType: typeof(FieldCampfireStewRecipe));
