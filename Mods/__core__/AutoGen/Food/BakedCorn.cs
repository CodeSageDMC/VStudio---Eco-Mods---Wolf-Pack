...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BakedCorn" item. 
    ...
    [LocDisplayName("Baked Corn")] // Defines the localized name of the item.
    [Weight(300)] // Defines how heavy the BakedCorn is.
    [Tag("BakedVegetable")]
    [Tag("BakedFood")]
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("Baked corn that retains more nutrients than more simple methods of cooking.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BakedCorn".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Baked Corn Item")]
    public partial class BakedCornRecipe : RecipeFamily
    {
        public BakedCornRecipe()
        {
            ...
            recipe.Init(
                name: "BakedCorn",  //noloc
                displayName: Localizer.DoStr("Baked Corn"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BakedCornRecipe), start: 2, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Baked Corn"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Baked Corn"), recipeType: typeof(BakedCornRecipe));
