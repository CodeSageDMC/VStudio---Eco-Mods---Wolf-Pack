...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CamasPaste" item. 
    ...
    [LocDisplayName("Camas Paste")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the CamasPaste is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Pulverized camas works as an excellent thickener or flavour enhancer.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CamasPaste".</para>
    ...
    [Ecopedia("Food", "Ingredients", subPageName: "Camas Paste Item")]
    public partial class CamasPasteRecipe : RecipeFamily
    {
        public CamasPasteRecipe()
        {
            ...
            recipe.Init(
                name: "CamasPaste",  //noloc
                displayName: Localizer.DoStr("Camas Paste"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CamasPasteRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Camas Paste"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Camas Paste"), recipeType: typeof(CamasPasteRecipe));
