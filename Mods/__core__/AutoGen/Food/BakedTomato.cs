...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Baked tomatoes might not look as red or plump as the raw variety, but they are nice and tasty.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BakedTomato".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Baked Tomato Item")]
    public partial class BakedTomatoRecipe : RecipeFamily
    {
        public BakedTomatoRecipe()
        {
            ...
            recipe.Init(
                name: "BakedTomato",  //noloc
                displayName: Localizer.DoStr("Baked Tomato"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BakedTomatoRecipe), start: 2, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Baked Tomato"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Baked Tomato"), recipeType: typeof(BakedTomatoRecipe));
