...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "MeatPie" item. 
    ...
    [LocDisplayName("Meat Pie")] // Defines the localized name of the item.
    [Weight(600)] // Defines how heavy the MeatPie is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("Much like a huckleberry pie, but filled to the brim with succulent meat.")] //The tooltip description for the food item.
    public partial class MeatPieItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 18, Fat = 20, Protein = 4, Vitamins = 2};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MeatPie".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Meat Pie Item")]
    public partial class MeatPieRecipe : RecipeFamily
    {
        public MeatPieRecipe()
        {
            ...
            recipe.Init(
                name: "MeatPie",  //noloc
                displayName: Localizer.DoStr("Meat Pie"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MeatPieRecipe), start: 2, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Meat Pie"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Meat Pie"), recipeType: typeof(MeatPieRecipe));
