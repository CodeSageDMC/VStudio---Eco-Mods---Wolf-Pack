...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Flatbread" item. 
    ...
    [LocDisplayName("Flatbread")] // Defines the localized name of the item.
    [Weight(200)] // Defines how heavy the Flatbread is.
    [Ecopedia("Food", "Baking", createAsSubPage: true)]
    [LocDescription("Without any leavening the flatbread isn't very puffy. But it's still tasty.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Flatbread".</para>
    ...
    [Ecopedia("Food", "Baking", subPageName: "Flatbread Item")]
    public partial class FlatbreadRecipe : RecipeFamily
    {
        public FlatbreadRecipe()
        {
            ...
            recipe.Init(
                name: "Flatbread",  //noloc
                displayName: Localizer.DoStr("Flatbread"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FlatbreadRecipe), start: 2, skillType: typeof(BakingSkill), typeof(BakingFocusedSpeedTalent), typeof(BakingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Flatbread"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Flatbread"), recipeType: typeof(FlatbreadRecipe));
