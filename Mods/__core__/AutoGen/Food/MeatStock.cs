...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "MeatStock" item. 
    ...
    [LocDisplayName("Meat Stock")] // Defines the localized name of the item.
    [Weight(800)] // Defines how heavy the MeatStock is.
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("A meaty stock made from the flesh of animals.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MeatStock".</para>
    ...
    public partial class MeatStockRecipe : RecipeFamily
    {
        public MeatStockRecipe()
        {
            ...
            recipe.Init(
                name: "MeatStock",  //noloc
                displayName: Localizer.DoStr("Meat Stock"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MeatStockRecipe), start: 8, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Meat Stock"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Meat Stock"), recipeType: typeof(MeatStockRecipe));
