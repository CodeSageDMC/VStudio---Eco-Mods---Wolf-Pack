...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "LoadedTaroFries" item. 
    ...
    [LocDisplayName("Loaded Taro Fries")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the LoadedTaroFries is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Taro Fries with extra everything.")] //The tooltip description for the food item.
    public partial class LoadedTaroFriesItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 14, Fat = 18, Protein = 6, Vitamins = 0};
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LoadedTaroFries".</para>
    ...
    public partial class LoadedTaroFriesRecipe : RecipeFamily
    {
        public LoadedTaroFriesRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LoadedTaroFriesRecipe), start: 2, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Loaded Taro Fries"), recipeType: typeof(LoadedTaroFriesRecipe));
