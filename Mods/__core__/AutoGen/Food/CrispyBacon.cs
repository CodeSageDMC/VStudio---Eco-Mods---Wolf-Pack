...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "CrispyBacon" item. 
    ...
    [LocDisplayName("Crispy Bacon")] // Defines the localized name of the item.
    [Weight(400)] // Defines how heavy the CrispyBacon is.
    [Ecopedia("Food", "Cooking", createAsSubPage: true)]
    [LocDescription("Give me all the bacon and eggs you have.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrispyBacon".</para>
    ...
    [Ecopedia("Food", "Cooking", subPageName: "Crispy Bacon Item")]
    public partial class CrispyBaconRecipe : RecipeFamily
    {
        public CrispyBaconRecipe()
        {
            ...
            recipe.Init(
                name: "CrispyBacon",  //noloc
                displayName: Localizer.DoStr("Crispy Bacon"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrispyBaconRecipe), start: 4, skillType: typeof(CookingSkill), typeof(CookingFocusedSpeedTalent), typeof(CookingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crispy Bacon"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crispy Bacon"), recipeType: typeof(CrispyBaconRecipe));
