...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "AmanitaMushroom" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsAmanitaMushroom : PlantLayerSettings
    {
        ...
        {
            this.Name = "AmanitaMushroom";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Amanita Mushroom")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Amanita Mushroom"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "AmanitaMushroom".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "AmanitaMushroom" entity.</para>
    ...
    public partial class AmanitaMushroom : PlantEntity
    {
        ...
        [Ecopedia("Plants", "Fungi", createAsSubPage: true)]  // Registers this plant species with the Ecopedia
        [Tag("Plants")]
        ...
        public partial class AmanitaMushroomSpecies : PlantSpecies
        {
            public AmanitaMushroomSpecies() : base()
            {
                ...
                this.Name = "AmanitaMushroom"; //noloc
                this.DisplayName = Localizer.DoStr("Amanita Mushroom"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(20, 35);
                this.GenerationDefinitions.PlantsInGroup = new Range(4, 12);
                this.GenerationDefinitions.CountOfClusters = new Range(2, 6);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 10);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.08f, 0.18f);
                this.GenerationDefinitions.StartBiomes = "WarmForestBiome";

                // Food
                this.CalorieValue = 1; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(AmanitaMushroomBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.05f }); //noloc
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 2 }); //noloc
