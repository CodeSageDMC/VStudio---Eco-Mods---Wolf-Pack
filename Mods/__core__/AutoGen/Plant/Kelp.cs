...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Kelp" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsKelp : PlantLayerSettings
    {
        ...
        {
            this.Name = "Kelp";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Kelp")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Kelp"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Kelp".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Kelp" entity.</para>
    ...
    public partial class Kelp : PlantEntity
    {
        ...
        public partial class KelpSpecies : PlantSpecies
        {
            public KelpSpecies() : base()
            {
                ...
                this.Name = "Kelp"; //noloc
                this.DisplayName = Localizer.DoStr("Kelp"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(50, 120);
                this.GenerationDefinitions.PlantsInGroup = new Range(35, 55);
                this.GenerationDefinitions.CountOfClusters = new Range(1, 1);
                this.GenerationDefinitions.RadiusOfGroup = new Range(12, 30);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(1, 1);
                this.GenerationDefinitions.StartBiomes = "OceanBiome";
                ...
                {
                    new SpeciesResource(typeof(KelpItem), new Range(2, 7), 1),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(KelpBlock); // Defines the block type represented by this plant

                // Climate
                this.ReleasesCO2TonsPerDay = -0.0001f; // Configures the amount of CO2 produced or removed by this plant per day.
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.05f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.05f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.05f }); //noloc
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "UnderwaterFertileGround", ConsumedCapacityPerPop = 4 }); //noloc
