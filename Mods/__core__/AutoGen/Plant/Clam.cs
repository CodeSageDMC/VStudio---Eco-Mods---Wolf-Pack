...
namespace Eco.Mods.WorldLayers
{
    ...
    /// <summary>
    /// <para>Server side layer settings definition for the "Clam" plant layer setting.</para>
    ...
    public partial class PlantLayerSettingsClam : PlantLayerSettings
    {
        ...
        {
            this.Name = "Clam";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Clam")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Clam"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Clam".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    /// <summary>
    /// <para>Server side entity definition for the "Clam" entity.</para>
    ...
    public partial class Clam : PlantEntity
    {
        ...
        public partial class ClamSpecies : PlantSpecies
        {
            public ClamSpecies() : base()
            {
                ...
                this.Name = "Clam"; //noloc
                this.DisplayName = Localizer.DoStr("Clam"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.ChanceToBeSpawnOutsideOfGroup = 0.5f;
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(25, 45);
                this.GenerationDefinitions.PlantsInGroup = new Range(4, 12);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 6);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 12);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.07f, 0.14f);
                ...
                // Visuals
                this.BlockType = typeof(ClamBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.02f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.02f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.02f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.02f }); //noloc
