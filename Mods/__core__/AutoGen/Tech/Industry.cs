...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Advanced industrialization to produce larger machines and advanced technology. Levels up by crafting related recipes.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Industry".</para>
    ...
    [Ecopedia("Professions", "Engineer", subPageName: "Industry Skill Book Item")]
        ...
        public IndustrySkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement("Modern Research", 10, typeof(MechanicsSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IndustrySkillBookRecipe), start: 30, skillType: typeof(MechanicsSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Industry Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Industry Skill Book"), recipeType: typeof(IndustrySkillBookRecipe));
