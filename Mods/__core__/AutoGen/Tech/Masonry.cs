...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Rocks and mortar can provide a suitable building material alternative to wood. Levels up by crafting related recipes.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Masonry".</para>
    ...
    [Ecopedia("Professions", "Mason", subPageName: "Masonry Skill Book Item")]
        ...
        public MasonrySkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(GatheringResearchPaperBasicItem), 3, typeof(MiningSkill)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MasonrySkillBookRecipe), start: 5, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Masonry Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Masonry Skill Book"), recipeType: typeof(MasonrySkillBookRecipe));
