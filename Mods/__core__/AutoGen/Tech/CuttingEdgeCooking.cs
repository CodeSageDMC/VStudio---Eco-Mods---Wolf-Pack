...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Professions", "Chef", subPageName: "Cutting Edge Cooking Skill Book Item")]
    public partial class CuttingEdgeCookingSkillBookRecipe : RecipeFamily
    {
        public CuttingEdgeCookingSkillBookRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CuttingEdgeCookingSkillBookRecipe), start: 60, skillType: typeof(AdvancedCookingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cutting Edge Cooking Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cutting Edge Cooking Skill Book"), recipeType: typeof(CuttingEdgeCookingSkillBookRecipe));
