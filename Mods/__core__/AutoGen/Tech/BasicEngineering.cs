...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Basic Engineering allows easier construction of roads and gives access to early forms of mechanical power. Levels up by crafting related recipes.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BasicEngineering".</para>
    ...
    [Ecopedia("Professions", "Engineer", subPageName: "Basic Engineering Skill Book Item")]
    public partial class BasicEngineeringSkillBookRecipe : RecipeFamily
    {
        public BasicEngineeringSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(DendrologyResearchPaperAdvancedItem), 3, typeof(CarpentrySkill)),
                    new IngredientElement(typeof(GeologyResearchPaperAdvancedItem), 3, typeof(CarpentrySkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BasicEngineeringSkillBookRecipe), start: 5, skillType: typeof(CarpentrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Basic Engineering Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Basic Engineering Skill Book"), recipeType: typeof(BasicEngineeringSkillBookRecipe));
