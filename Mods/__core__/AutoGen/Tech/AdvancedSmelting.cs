...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdvancedSmelting".</para>
    ...
    [Ecopedia("Professions", "Smith", subPageName: "Advanced Smelting Skill Book Item")]
    public partial class AdvancedSmeltingSkillBookRecipe : RecipeFamily
    {
        public AdvancedSmeltingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(MetallurgyResearchPaperBasicItem), 20, typeof(SmeltingSkill)),
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 20, typeof(SmeltingSkill)),
                    new IngredientElement("Basic Research", 10, typeof(SmeltingSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedSmeltingSkillBookRecipe), start: 30, skillType: typeof(SmeltingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Advanced Smelting Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Advanced Smelting Skill Book"), recipeType: typeof(AdvancedSmeltingSkillBookRecipe));
