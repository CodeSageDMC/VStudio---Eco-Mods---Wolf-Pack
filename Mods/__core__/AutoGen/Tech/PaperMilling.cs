...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Paper to carry the written word. Or used to stuff in bookshelves. Levels up by crafting related recipes.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PaperMilling".</para>
    ...
    [Ecopedia("Professions", "Carpenter", subPageName: "Paper Milling Skill Book Item")]
        ...
        public PaperMillingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(GatheringResearchPaperBasicItem), 5, typeof(CarpentrySkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PaperMillingSkillBookRecipe), start: 15, skillType: typeof(CarpentrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Paper Milling Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Paper Milling Skill Book"), recipeType: typeof(PaperMillingSkillBookRecipe));
