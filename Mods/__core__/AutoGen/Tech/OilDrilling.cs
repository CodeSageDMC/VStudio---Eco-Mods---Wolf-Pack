...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("While it takes some advanced tools and constructions, harvesting and refining oil can be an important step. Levels up by crafting related recipes.")]
    ...
    [Ecopedia("Professions", "Scientist", subPageName: "Oil Drilling Skill Book Item")]
    public partial class OilDrillingSkillBookRecipe : RecipeFamily
    {
        public OilDrillingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(AgricultureResearchPaperAdvancedItem), 10, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperModernItem), 10, typeof(MechanicsSkill)),
                    new IngredientElement(typeof(DendrologyResearchPaperModernItem), 10, typeof(MechanicsSkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(OilDrillingSkillBookRecipe), start: 30, skillType: typeof(MechanicsSkill));
            ...
            this.Initialize(displayText: Localizer.DoStr("Oil Drilling Skill Book"), recipeType: typeof(OilDrillingSkillBookRecipe));
