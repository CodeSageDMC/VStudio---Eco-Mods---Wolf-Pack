...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("A painter uses different combination of liquids and powders to create a practical application of colors.")]
    ...
    [Ecopedia("Professions", "Scientist", subPageName: "Painting Skill Book Item")]
    public partial class PaintingSkillBookRecipe : RecipeFamily
    {
        public PaintingSkillBookRecipe()
        {
            ...
            this.Initialize(displayText: Localizer.DoStr("Painting Skill Book"), recipeType: typeof(PaintingSkillBookRecipe));
