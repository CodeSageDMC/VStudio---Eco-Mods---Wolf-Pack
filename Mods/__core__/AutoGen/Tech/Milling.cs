...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Milling".</para>
    ...
    [Ecopedia("Professions", "Farmer", subPageName: "Milling Skill Book Item")]
    public partial class MillingSkillBookRecipe : RecipeFamily
    {
        public MillingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(DendrologyResearchPaperBasicItem), 5, typeof(FarmingSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperBasicItem), 5, typeof(FarmingSkill)),
                    new IngredientElement(typeof(CulinaryResearchPaperBasicItem), 5, typeof(FarmingSkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MillingSkillBookRecipe), start: 15, skillType: typeof(FarmingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Milling Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Milling Skill Book"), recipeType: typeof(MillingSkillBookRecipe));
