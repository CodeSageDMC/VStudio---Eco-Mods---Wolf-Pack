...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Cutting logs into usable crafting and building materials is an important skill for budding communities. Levels up by crafting related recipes.")]
    ...
    [Ecopedia("Professions", "Carpenter", subPageName: "Carpentry Skill Book Item")]
        ...
        public CarpentrySkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(GatheringResearchPaperBasicItem), 3,typeof(LoggingSkill)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CarpentrySkillBookRecipe), start: 5, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Carpentry Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Carpentry Skill Book"), recipeType: typeof(CarpentrySkillBookRecipe));
