...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Advanced baking mostly improves recipes that involve a leavening agent. Levels up by crafting advanced baking recipes.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdvancedBaking".</para>
    ...
    [Ecopedia("Professions", "Chef", subPageName: "Advanced Baking Skill Book Item")]
    public partial class AdvancedBakingSkillBookRecipe : RecipeFamily
    {
        public AdvancedBakingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CulinaryResearchPaperAdvancedItem), 20, typeof(BakingSkill)),
                    new IngredientElement(typeof(DendrologyResearchPaperModernItem), 10, typeof(BakingSkill)),
                    new IngredientElement(typeof(GeologyResearchPaperModernItem), 10, typeof(BakingSkill)),
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(6000, typeof(BakingSkill));

            // Defines our crafting time for the recipe
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedBakingSkillBookRecipe), start: 30, skillType: typeof(BakingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Advanced Baking Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Advanced Baking Skill Book"), recipeType: typeof(AdvancedBakingSkillBookRecipe));
