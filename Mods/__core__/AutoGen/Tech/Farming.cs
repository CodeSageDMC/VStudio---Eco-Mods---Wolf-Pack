...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("The art of planting and cultivating flora. Levels up by crafting related recipes and using the hoe.")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Farming".</para>
    ...
    [Ecopedia("Professions", "Farmer", subPageName: "Farming Skill Book Item")]
        ...
        public FarmingSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(GeologyResearchPaperBasicItem), 1,typeof(GatheringSkill)),
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300,typeof(GatheringSkill));

            // Defines our crafting time for the recipe
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FarmingSkillBookRecipe), start: 5, skillType: typeof(GatheringSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Farming Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Farming Skill Book"), recipeType: typeof(FarmingSkillBookRecipe));
