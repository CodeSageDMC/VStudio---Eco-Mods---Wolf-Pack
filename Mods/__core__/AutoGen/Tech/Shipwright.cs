...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Shipwright".</para>
    ...
    [Ecopedia("Professions", "Carpenter", subPageName: "Shipwright Skill Book Item")]
    public partial class ShipwrightSkillBookRecipe : RecipeFamily
    {
        public ShipwrightSkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(DendrologyResearchPaperBasicItem), 5,typeof(LoggingSkill)),
                    new IngredientElement(typeof(GatheringResearchPaperBasicItem), 5,typeof(LoggingSkill)),
                    new IngredientElement("Basic Research", 10,typeof(LoggingSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ShipwrightSkillBookRecipe), start: 15, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Shipwright Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Shipwright Skill Book"), recipeType: typeof(ShipwrightSkillBookRecipe));
