...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Simple low indoors working shoes helps avoiding slipping on wet surfaces in a large kitchen.\n\n(Decreases calories consumed when using tools by 30\u0025)")] //The tooltip description for this clothing item.
    ...
    public partial class ChefShoesRecipe : RecipeFamily
    {
        public ChefShoesRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(SyntheticRubberItem), 2, typeof(TailoringSkill)),
                    new IngredientElement(typeof(NylonFabricItem), 5, typeof(TailoringSkill)),
                    new IngredientElement(typeof(CottonFabricItem), 20, typeof(TailoringSkill)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ChefShoesRecipe), start: 10, skillType: typeof(TailoringSkill));
