...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Can you carry as much as a bear! Not really, but it helps you carry more.\n\n(Increases max carry weight by 15 kg)")] //The tooltip description for this clothing item.
    ...
    public partial class BearpackRecipe : RecipeFamily
    {
        public BearpackRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CelluloseFiberItem), 20, typeof(TailoringSkill)),
                    new IngredientElement(typeof(FurPeltItem), 25, typeof(TailoringSkill)),
                    new IngredientElement("Fabric", 30, typeof(TailoringSkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BearpackRecipe), start: 10, skillType: typeof(TailoringSkill));
