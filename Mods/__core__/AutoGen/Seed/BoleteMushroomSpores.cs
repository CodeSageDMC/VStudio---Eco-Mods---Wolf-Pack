...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "BoleteMushroomSpores" item. 
    ...
    [LocDisplayName("Bolete Mushroom Spores")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BoleteMushroomSpores is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow bolete mushrooms.")] //The tooltip description for the food item.
    public partial class BoleteMushroomSporesItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("BoleteMushroom");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "BoleteMushroomSpores Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Bolete Mushroom Spores Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BoleteMushroomSpores is.
    [LocDescription("Plant to grow bolete mushrooms.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BoleteMushroomSpores".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Bolete Mushroom Spores Item")]
    public partial class BoleteMushroomSporesRecipe : RecipeFamily
    {
        public BoleteMushroomSporesRecipe()
        {
            ...
            recipe.Init(
                name: "BoleteMushroomSpores",  //noloc
                displayName: Localizer.DoStr("Bolete Mushroom Spores"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoleteMushroomSporesRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bolete Mushroom Spores"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bolete Mushroom Spores"), recipeType: typeof(BoleteMushroomSporesRecipe));
