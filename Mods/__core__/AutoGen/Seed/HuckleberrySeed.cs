...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "HuckleberrySeed" item. 
    ...
    [LocDisplayName("Huckleberry Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the HuckleberrySeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow a huckleberry bush.")] //The tooltip description for the food item.
    public partial class HuckleberrySeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Huckleberry");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "HuckleberrySeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Huckleberry Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the HuckleberrySeed is.
    [LocDescription("Plant to grow a huckleberry bush.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "HuckleberrySeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Huckleberry Seed Item")]
    public partial class HuckleberrySeedRecipe : RecipeFamily
    {
        public HuckleberrySeedRecipe()
        {
            ...
            recipe.Init(
                name: "HuckleberrySeed",  //noloc
                displayName: Localizer.DoStr("Huckleberry Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(HuckleberrySeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Huckleberry Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Huckleberry Seed"), recipeType: typeof(HuckleberrySeedRecipe));
