...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "FlaxSeed" item. 
    ...
    [LocDisplayName("Flax Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the FlaxSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow flax. ")] //The tooltip description for the food item.
    public partial class FlaxSeedItem : SeedItem
    {
        static FlaxSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Flax");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "FlaxSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Flax Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the FlaxSeed is.
    [LocDescription("Plant to grow flax. ")] //The tooltip description for the seed pack item.
    public partial class FlaxSeedPackItem : SeedPackItem
    {
        static FlaxSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Flax"); } }
    }


    /// <summary>
    /// <para>Server side recipe definition for "FlaxSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Flax Seed Item")]
    public partial class FlaxSeedRecipe : RecipeFamily
    {
        public FlaxSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "FlaxSeed",  //noloc
                displayName: Localizer.DoStr("Flax Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(FlaxStemItem), 0.5f, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<FlaxSeedItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FlaxSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Flax Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Flax Seed"), recipeType: typeof(FlaxSeedRecipe));
