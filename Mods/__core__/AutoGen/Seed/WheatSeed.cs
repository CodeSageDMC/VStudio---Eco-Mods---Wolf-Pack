...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "WheatSeed" item. 
    ...
    [LocDisplayName("Wheat Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the WheatSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow wheat.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "WheatSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Wheat Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the WheatSeed is.
    [LocDescription("Plant to grow wheat.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WheatSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Wheat Seed Item")]
    public partial class WheatSeedRecipe : RecipeFamily
    {
        public WheatSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "WheatSeed",  //noloc
                displayName: Localizer.DoStr("Wheat Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(WheatItem), 0.5f, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WheatSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wheat Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wheat Seed"), recipeType: typeof(WheatSeedRecipe));
