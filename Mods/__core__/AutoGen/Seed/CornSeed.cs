...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "CornSeed" item. 
    ...
    [LocDisplayName("Corn Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CornSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow corn.")] //The tooltip description for the food item.
    public partial class CornSeedItem : SeedItem
    {
        static CornSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Corn");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "CornSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Corn Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CornSeed is.
    [LocDescription("Plant to grow corn.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CornSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Corn Seed Item")]
    public partial class CornSeedRecipe : RecipeFamily
    {
        public CornSeedRecipe()
        {
            ...
            recipe.Init(
                name: "CornSeed",  //noloc
                displayName: Localizer.DoStr("Corn Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CornSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Corn Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Corn Seed"), recipeType: typeof(CornSeedRecipe));
