...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Cookeina Mushroom Spores")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CookeinaMushroomSpores is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow cookeina mushrooms.")] //The tooltip description for the food item.
    public partial class CookeinaMushroomSporesItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("CookeinaMushroom");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "CookeinaMushroomSpores Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Cookeina Mushroom Spores Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CookeinaMushroomSpores is.
    [LocDescription("Plant to grow cookeina mushrooms.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CookeinaMushroomSpores".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Cookeina Mushroom Spores Item")]
    public partial class CookeinaMushroomSporesRecipe : RecipeFamily
    {
        public CookeinaMushroomSporesRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CookeinaMushroomSpores",  //noloc
                displayName: Localizer.DoStr("Cookeina Mushroom Spores"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CookeinaMushroomSporesRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cookeina Mushroom Spores"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cookeina Mushroom Spores"), recipeType: typeof(CookeinaMushroomSporesRecipe));
