...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "CreosoteBushSeed" item. 
    ...
    [LocDisplayName("Creosote Bush Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CreosoteBushSeed is.
    ...
    [LocDescription("Plant to grow creosote bushes.")] //The tooltip description for the food item.
    public partial class CreosoteBushSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("CreosoteBush");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "CreosoteBushSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Creosote Bush Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CreosoteBushSeed is.
    [LocDescription("Plant to grow creosote bushes.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CreosoteBushSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Creosote Bush Seed Item")]
    public partial class CreosoteBushSeedRecipe : RecipeFamily
    {
        public CreosoteBushSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CreosoteBushSeed",  //noloc
                displayName: Localizer.DoStr("Creosote Bush Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(CreosoteFlowerItem), 2, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<CreosoteBushSeedItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CreosoteBushSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Creosote Bush Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Creosote Bush Seed"), recipeType: typeof(CreosoteBushSeedRecipe));
