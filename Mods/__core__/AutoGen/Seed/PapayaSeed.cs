...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "PapayaSeed" item. 
    ...
    [LocDisplayName("Papaya Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PapayaSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow a papaya plant.")] //The tooltip description for the food item.
    public partial class PapayaSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Papaya");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "PapayaSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Papaya Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the PapayaSeed is.
    [LocDescription("Plant to grow a papaya plant.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PapayaSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Papaya Seed Item")]
    public partial class PapayaSeedRecipe : RecipeFamily
    {
        public PapayaSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PapayaSeed",  //noloc
                displayName: Localizer.DoStr("Papaya Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PapayaSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Papaya Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Papaya Seed"), recipeType: typeof(PapayaSeedRecipe));
