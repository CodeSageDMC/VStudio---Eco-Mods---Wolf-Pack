...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "PumpkinSeed" item. 
    ...
    [LocDisplayName("Pumpkin Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PumpkinSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow a pumpkin.")] //The tooltip description for the food item.
    public partial class PumpkinSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Pumpkin");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "PumpkinSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Pumpkin Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the PumpkinSeed is.
    [LocDescription("Plant to grow a pumpkin.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PumpkinSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Pumpkin Seed Item")]
    public partial class PumpkinSeedRecipe : RecipeFamily
    {
        public PumpkinSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PumpkinSeed",  //noloc
                displayName: Localizer.DoStr("Pumpkin Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(PumpkinItem), 1, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PumpkinSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pumpkin Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pumpkin Seed"), recipeType: typeof(PumpkinSeedRecipe));
