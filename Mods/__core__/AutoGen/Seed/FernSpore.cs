...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "FernSpore" item. 
    ...
    [LocDisplayName("Fern Spore")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the FernSpore is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow ferns.")] //The tooltip description for the food item.
    public partial class FernSporeItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Fern");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "FernSpore Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Fern Spore Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the FernSpore is.
    [LocDescription("Plant to grow ferns.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "FernSpore".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Fern Spore Item")]
    public partial class FernSporeRecipe : RecipeFamily
    {
        public FernSporeRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "FernSpore",  //noloc
                displayName: Localizer.DoStr("Fern Spore"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FernSporeRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fern Spore"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fern Spore"), recipeType: typeof(FernSporeRecipe));
