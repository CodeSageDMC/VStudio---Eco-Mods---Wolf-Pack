...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "PricklyPearSeed" item. 
    ...
    [LocDisplayName("Prickly Pear Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PricklyPearSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow prickly pear cacti.")] //The tooltip description for the food item.
    public partial class PricklyPearSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("PricklyPear");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "PricklyPearSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Prickly Pear Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the PricklyPearSeed is.
    [LocDescription("Plant to grow prickly pear cacti.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PricklyPearSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Prickly Pear Seed Item")]
    public partial class PricklyPearSeedRecipe : RecipeFamily
    {
        public PricklyPearSeedRecipe()
        {
            ...
            recipe.Init(
                name: "PricklyPearSeed",  //noloc
                displayName: Localizer.DoStr("Prickly Pear Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PricklyPearSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Prickly Pear Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Prickly Pear Seed"), recipeType: typeof(PricklyPearSeedRecipe));
