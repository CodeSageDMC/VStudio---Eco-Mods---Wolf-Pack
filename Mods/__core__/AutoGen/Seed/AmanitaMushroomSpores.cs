...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "AmanitaMushroomSpores" item. 
    ...
    [LocDisplayName("Amanita Mushroom Spores")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the AmanitaMushroomSpores is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow amanita mushrooms. Not sure why you'd want these poisonous mushrooms, though.")] //The tooltip description for the food item.
    public partial class AmanitaMushroomSporesItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("AmanitaMushroom");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "AmanitaMushroomSpores Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Amanita Mushroom Spores Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the AmanitaMushroomSpores is.
    [LocDescription("Plant to grow amanita mushrooms. Not sure why you'd want these poisonous mushrooms, though.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AmanitaMushroomSpores".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Amanita Mushroom Spores Item")]
    public partial class AmanitaMushroomSporesRecipe : RecipeFamily
    {
        public AmanitaMushroomSporesRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AmanitaMushroomSpores",  //noloc
                displayName: Localizer.DoStr("Amanita Mushroom Spores"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AmanitaMushroomSporesRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Amanita Mushroom Spores"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Amanita Mushroom Spores"), recipeType: typeof(AmanitaMushroomSporesRecipe));
