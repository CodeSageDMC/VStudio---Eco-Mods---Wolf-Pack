...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "CottonSeed" item. 
    ...
    [LocDisplayName("Cotton Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CottonSeed is.
    ...
    [LocDescription("Plant to grow cotton.")] //The tooltip description for the food item.
    public partial class CottonSeedItem : SeedItem
    {
        static CottonSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Cotton");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "CottonSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Cotton Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CottonSeed is.
    [LocDescription("Plant to grow cotton.")] //The tooltip description for the seed pack item.
    public partial class CottonSeedPackItem : SeedPackItem
    {
        static CottonSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Cotton"); } }
    }


    /// <summary>
    /// <para>Server side recipe definition for "CottonSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Cotton Seed Item")]
    public partial class CottonSeedRecipe : RecipeFamily
    {
        public CottonSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CottonSeed",  //noloc
                displayName: Localizer.DoStr("Cotton Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(CottonBollItem), 2, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<CottonSeedItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CottonSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cotton Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cotton Seed"), recipeType: typeof(CottonSeedRecipe));
