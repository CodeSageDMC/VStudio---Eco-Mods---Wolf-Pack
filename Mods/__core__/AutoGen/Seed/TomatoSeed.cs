...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "TomatoSeed" item. 
    ...
    [LocDisplayName("Tomato Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the TomatoSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow tomato plants.")] //The tooltip description for the food item.
    public partial class TomatoSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Tomatoes");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "TomatoSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Tomato Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the TomatoSeed is.
    [LocDescription("Plant to grow tomato plants.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TomatoSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Tomato Seed Item")]
    public partial class TomatoSeedRecipe : RecipeFamily
    {
        public TomatoSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "TomatoSeed",  //noloc
                displayName: Localizer.DoStr("Tomato Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TomatoSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Tomato Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Tomato Seed"), recipeType: typeof(TomatoSeedRecipe));
