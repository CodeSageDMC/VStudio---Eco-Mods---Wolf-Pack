...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "TaroSeed" item. 
    ...
    [LocDisplayName("Taro Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the TaroSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow taro.")] //The tooltip description for the food item.
    public partial class TaroSeedItem : SeedItem
    {
        static TaroSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Taro");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "TaroSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Taro Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the TaroSeed is.
    [LocDescription("Plant to grow taro.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TaroSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Taro Seed Item")]
    public partial class TaroSeedRecipe : RecipeFamily
    {
        public TaroSeedRecipe()
        {
            ...
            recipe.Init(
                name: "TaroSeed",  //noloc
                displayName: Localizer.DoStr("Taro Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TaroSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Taro Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Taro Seed"), recipeType: typeof(TaroSeedRecipe));
