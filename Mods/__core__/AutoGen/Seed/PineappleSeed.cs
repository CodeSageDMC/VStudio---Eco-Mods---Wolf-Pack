...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "PineappleSeed" item. 
    ...
    [LocDisplayName("Pineapple Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PineappleSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow a pineapple plant.")] //The tooltip description for the food item.
    public partial class PineappleSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Pineapple");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "PineappleSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Pineapple Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the PineappleSeed is.
    [LocDescription("Plant to grow a pineapple plant.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PineappleSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Pineapple Seed Item")]
    public partial class PineappleSeedRecipe : RecipeFamily
    {
        public PineappleSeedRecipe()
        {
            ...
            recipe.Init(
                name: "PineappleSeed",  //noloc
                displayName: Localizer.DoStr("Pineapple Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PineappleSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pineapple Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pineapple Seed"), recipeType: typeof(PineappleSeedRecipe));
