...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "AgaveSeed" item. 
    ...
    [LocDisplayName("Agave Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the AgaveSeed is.
    ...
    [Tag("Crop Seed")]
    [LocDescription("Plant to grow an agave plant.")] //The tooltip description for the food item.
    public partial class AgaveSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Agave");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "AgaveSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Agave Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the AgaveSeed is.
    [LocDescription("Plant to grow an agave plant.")] //The tooltip description for the seed pack item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AgaveSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Agave Seed Item")]
    public partial class AgaveSeedRecipe : RecipeFamily
    {
        public AgaveSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AgaveSeed",  //noloc
                displayName: Localizer.DoStr("Agave Seed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AgaveSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Agave Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Agave Seed"), recipeType: typeof(AgaveSeedRecipe));
