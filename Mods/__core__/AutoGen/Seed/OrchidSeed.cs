...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side seed item definition for the "OrchidSeed" item. 
    ...
    [LocDisplayName("Orchid Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the OrchidSeed is.
    ...
    [LocDescription("Plant to grow an orchid.")] //The tooltip description for the food item.
    public partial class OrchidSeedItem : SeedItem
    {
        static OrchidSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Orchid");
    ...
    /// <summary>
    /// <para>
    /// Server side seed pack item definition for the "OrchidSeed Pack" item. 
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Orchid Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the OrchidSeed is.
    [LocDescription("Plant to grow an orchid.")] //The tooltip description for the seed pack item.
    public partial class OrchidSeedPackItem : SeedPackItem
    {
        static OrchidSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Orchid"); } }
    }


    /// <summary>
    /// <para>Server side recipe definition for "OrchidSeed".</para>
    ...
    [Ecopedia("Food", "Seed", subPageName: "Orchid Seed Item")]
    public partial class OrchidSeedRecipe : RecipeFamily
    {
        public OrchidSeedRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "OrchidSeed",  //noloc
                displayName: Localizer.DoStr("Orchid Seed"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(OrchidItem), 2, typeof(FarmingSkill), typeof(FarmingLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<OrchidSeedItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(OrchidSeedRecipe), start: 0.4f, skillType: typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Orchid Seed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Orchid Seed"), recipeType: typeof(OrchidSeedRecipe));
