...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("An elevator for transporting loads vertically.")]
    [IconGroup("World Object Minimap")]
    [Weight(50000)]
    [Ecopedia("Crafted Objects", "Specialty", createAsSubPage: true)]
    public partial class WoodenElevatorItem : WorldObjectItem<WoodenElevatorObject>, IPersistentData
    {
        [Serialized, SyncToView, NewTooltipChildren(CacheAs.Instance, flags: TTFlags.AllowNonControllerTypeForChildren)] public object PersistentData { get; set; }
    }

    /// <summary>
    /// <para>Server side recipe definition for "WoodenElevator".</para>
    ...
    [Ecopedia("Crafted Objects", "Specialty", subPageName: "Wooden Elevator Item")]
    public partial class WoodenElevatorRecipe : RecipeFamily
    {
        public WoodenElevatorRecipe()
        {
            ...
            recipe.Init(
                name: "WoodenElevator",  //noloc
                displayName: Localizer.DoStr("Wooden Elevator"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(CelluloseFiberItem), 4, typeof(MechanicsSkill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WoodenElevatorRecipe), start: 10, skillType: typeof(MechanicsSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wooden Elevator"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wooden Elevator"), recipeType: typeof(WoodenElevatorRecipe));
    ...
    [Ecopedia("Crafted Objects", "Specialty", subPageName: "WoodenElevator Item")]
    public partial class WoodenElevatorObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodenElevatorObject()
        {
            WorldObject.AddOccupancy<WoodenElevatorObject>(new List<BlockOccupancy>(0));
        }
        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override bool PlacesBlocks            => false;
        public override LocString DisplayName { get { return Localizer.DoStr("Wooden Elevator"); } }
        public Type RepresentedItemType { get { return typeof(WoodenElevatorItem); } }
