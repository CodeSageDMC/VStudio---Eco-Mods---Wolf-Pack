...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedIronOre".</para>
    ...
    [Ecopedia("Blocks", "Processed Rock", subPageName: "Crushed Iron Ore Item")]
    public partial class CrushedIronOreRecipe : RecipeFamily
    {
        public CrushedIronOreRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CrushedIronOre",  //noloc
                displayName: Localizer.DoStr("Crushed Iron Ore"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedIronOreRecipe), start: 2, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Iron Ore"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Iron Ore"), recipeType: typeof(CrushedIronOreRecipe));
