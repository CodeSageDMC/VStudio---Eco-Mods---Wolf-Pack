...
namespace Eco.Mods.TechTree
{
    ...
    [Solid, Wall, Constructed,BuildRoomMaterialOption]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(MortaredBasaltItem); } }
    }
    ...
    [Serialized, Solid] public class MortaredBasaltStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class MortaredBasaltStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class MortaredBasaltStacked3Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 MortaredBasalt
}
