...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeSpruceLumber".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Blocks", "Building Materials", subPageName: "Composite Spruce Lumber Item")]
    public partial class CompositeSpruceLumberRecipe : Recipe
    {
        public CompositeSpruceLumberRecipe()
        {
            this.Init(
                name: "CompositeSpruceLumber",  //noloc
                displayName: Localizer.DoStr("Composite Spruce Lumber"),
    ...
    [Serialized, Solid] public class CompositeSpruceLumberStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeSpruceLumberStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeSpruceLumberStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class CompositeSpruceLumberStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 CompositeSpruceLumber
}
