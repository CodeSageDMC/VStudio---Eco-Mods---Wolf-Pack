...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "IronConcentrate".</para>
    ...
    {
        public IronConcentrateRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "IronConcentrate",  //noloc
                displayName: Localizer.DoStr("Iron Concentrate"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronConcentrateRecipe), start: 1.5f, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Iron Concentrate"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Iron Concentrate"), recipeType: typeof(IronConcentrateRecipe));
