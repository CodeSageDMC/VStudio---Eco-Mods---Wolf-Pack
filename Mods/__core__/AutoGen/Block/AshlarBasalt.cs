...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AshlarBasalt".</para>
    ...
    [Ecopedia("Blocks", "Building Materials", subPageName: "Ashlar Basalt Item")]
    public partial class AshlarBasaltRecipe : RecipeFamily
    {
        public AshlarBasaltRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AshlarBasalt",  //noloc
                ...
                {
                    new CraftingElement<AshlarBasaltItem>(2),
                    new CraftingElement<CrushedBasaltItem>(typeof(AdvancedMasonrySkill), 2, typeof(AdvancedMasonryLavishResourcesTalent)),
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AshlarBasaltRecipe), start: 0.64f, skillType: typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Ashlar Basalt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Ashlar Basalt"), recipeType: typeof(AshlarBasaltRecipe));
    ...
    [RequiresSkill(typeof(AdvancedMasonrySkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(AshlarBasaltItem); } }
    }
    ...
    [Serialized, Solid] public class AshlarBasaltStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarBasaltStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarBasaltStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class AshlarBasaltStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 AshlarBasalt
}
