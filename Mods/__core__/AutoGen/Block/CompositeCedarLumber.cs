...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeCedarLumber".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Blocks", "Building Materials", subPageName: "Composite Cedar Lumber Item")]
    public partial class CompositeCedarLumberRecipe : Recipe
    {
        public CompositeCedarLumberRecipe()
        {
            this.Init(
                name: "CompositeCedarLumber",  //noloc
                displayName: Localizer.DoStr("Composite Cedar Lumber"),
    ...
    [RequiresSkill(typeof(CompositesSkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(CompositeCedarLumberItem); } }
    }
    ...
    [Serialized, Solid] public class CompositeCedarLumberStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeCedarLumberStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeCedarLumberStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class CompositeCedarLumberStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 CompositeCedarLumber
}
