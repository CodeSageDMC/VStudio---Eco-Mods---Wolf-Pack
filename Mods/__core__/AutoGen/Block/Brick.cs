...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BrickRecipe : RecipeFamily
    {
        public BrickRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BrickRecipe), start: 0.32f, skillType: typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Brick"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Brick"), recipeType: typeof(BrickRecipe));
