...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedCopperOre".</para>
    ...
    [Ecopedia("Blocks", "Processed Rock", subPageName: "Crushed Copper Ore Item")]
    public partial class CrushedCopperOreRecipe : RecipeFamily
    {
        public CrushedCopperOreRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CrushedCopperOre",  //noloc
                displayName: Localizer.DoStr("Crushed Copper Ore"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedCopperOreRecipe), start: 2, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Copper Ore"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Copper Ore"), recipeType: typeof(CrushedCopperOreRecipe));
