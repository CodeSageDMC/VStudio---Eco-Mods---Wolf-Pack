...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LumberRecipe : RecipeFamily
    {
        public LumberRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LumberRecipe), start: 0.32f, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Lumber"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Lumber"), recipeType: typeof(LumberRecipe));
