...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AshlarGneiss".</para>
    ...
    [Ecopedia("Blocks", "Building Materials", subPageName: "Ashlar Gneiss Item")]
    public partial class AshlarGneissRecipe : RecipeFamily
    {
        public AshlarGneissRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<AshlarGneissItem>(2),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AshlarGneissRecipe), start: 0.64f, skillType: typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Ashlar Gneiss"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Ashlar Gneiss"), recipeType: typeof(AshlarGneissRecipe));
    ...
    [Serialized, Solid] public class AshlarGneissStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarGneissStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarGneissStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class AshlarGneissStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 AshlarGneiss
}
