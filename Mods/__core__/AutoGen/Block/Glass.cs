    ...
    public partial class GlassRecipe : RecipeFamily
    {
        public GlassRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(SandItem), 4, typeof(GlassworkingSkill), typeof(GlassworkingLavishResourcesTalent)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GlassRecipe), start: 1.2f, skillType: typeof(GlassworkingSkill), typeof(GlassworkingFocusedSpeedTalent), typeof(GlassworkingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Glass"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Glass"), recipeType: typeof(GlassRecipe));
