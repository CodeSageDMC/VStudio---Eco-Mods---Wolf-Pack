...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ReinforcedConcrete".</para>
    ...
    public partial class ReinforcedConcreteRecipe : RecipeFamily
    {
        public ReinforcedConcreteRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement("CrushedRock", 5, typeof(MasonrySkill), typeof(MasonryLavishResourcesTalent)), //noloc
                },
                ...
                {
                    new CraftingElement<ReinforcedConcreteItem>(5)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ReinforcedConcreteRecipe), start: 0.64f, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Reinforced Concrete"
    ...
    [RequiresSkill(typeof(MasonrySkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(ReinforcedConcreteItem); } }
    }
    ...
    [Serialized, Solid] public class ReinforcedConcreteStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("Concrete")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class ReinforcedConcreteStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("Concrete")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class ReinforcedConcreteStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("Concrete")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class ReinforcedConcreteStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 ReinforcedConcrete
}
