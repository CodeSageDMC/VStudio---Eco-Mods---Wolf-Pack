...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "StoneRoad".</para>
    ...
    public partial class StoneRoadRecipe : RecipeFamily
    {
        public StoneRoadRecipe()
        {
            ...
            recipe.Init(
                name: "StoneRoad",  //noloc
                displayName: Localizer.DoStr("Stone Road"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(StoneRoadRecipe), start: 0.5f, skillType: typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Stone Road"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stone Road"), recipeType: typeof(StoneRoadRecipe));
