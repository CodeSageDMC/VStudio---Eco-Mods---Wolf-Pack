...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedGranite".</para>
    ...
    public partial class CrushedGraniteRecipe : RecipeFamily
    {
        public CrushedGraniteRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedGraniteRecipe), start: 2, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Granite"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Granite"), recipeType: typeof(CrushedGraniteRecipe));
