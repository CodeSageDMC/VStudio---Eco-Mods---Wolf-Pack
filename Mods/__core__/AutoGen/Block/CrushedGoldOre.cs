...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedGoldOre".</para>
    ...
    [Ecopedia("Blocks", "Processed Rock", subPageName: "Crushed Gold Ore Item")]
    public partial class CrushedGoldOreRecipe : RecipeFamily
    {
        public CrushedGoldOreRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CrushedGoldOre",  //noloc
                displayName: Localizer.DoStr("Crushed Gold Ore"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedGoldOreRecipe), start: 2, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Gold Ore"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Gold Ore"), recipeType: typeof(CrushedGoldOreRecipe));
    ...
    [Tag(BlockTags.Diggable)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(CrushedGoldOreItem); } }
    }
