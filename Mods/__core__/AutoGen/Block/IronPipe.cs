...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronPipeRecipe : RecipeFamily
    {
        public IronPipeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronPipeRecipe), start: 0.8f, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Iron Pipe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Iron Pipe"), recipeType: typeof(IronPipeRecipe));
    ...
    [RequiresSkill(typeof(SmeltingSkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(IronPipeItem); } }
    }
