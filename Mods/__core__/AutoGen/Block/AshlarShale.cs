...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AshlarShale".</para>
    ...
    [Ecopedia("Blocks", "Building Materials", subPageName: "Ashlar Shale Item")]
    public partial class AshlarShaleRecipe : RecipeFamily
    {
        public AshlarShaleRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AshlarShale",  //noloc
                ...
                {
                    new CraftingElement<AshlarShaleItem>(2),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AshlarShaleRecipe), start: 0.64f, skillType: typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Ashlar Shale"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Ashlar Shale"), recipeType: typeof(AshlarShaleRecipe));
    ...
    [RequiresSkill(typeof(AdvancedMasonrySkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(AshlarShaleItem); } }
    }
    ...
    [Serialized, Solid] public class AshlarShaleStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarShaleStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class AshlarShaleStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("AshlarStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class AshlarShaleStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 AshlarShale
}
