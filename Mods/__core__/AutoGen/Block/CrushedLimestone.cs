...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CrushedLimestone".</para>
    ...
    public partial class CrushedLimestoneRecipe : RecipeFamily
    {
        public CrushedLimestoneRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushedLimestoneRecipe), start: 2, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Crushed Limestone"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Crushed Limestone"), recipeType: typeof(CrushedLimestoneRecipe));
