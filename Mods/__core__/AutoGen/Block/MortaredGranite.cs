...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MortaredGranite".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Blocks", "Building Materials", subPageName: "Mortared Granite Item")]
    public partial class MortaredGraniteRecipe : Recipe
    {
        public MortaredGraniteRecipe()
        {
            this.Init(
                name: "MortaredGranite",  //noloc
                displayName: Localizer.DoStr("Mortared Granite"),
    ...
    [RequiresSkill(typeof(MasonrySkill), 2)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(MortaredGraniteItem); } }
    }
    ...
    [Serialized, Solid] public class MortaredGraniteStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("MortaredStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class MortaredGraniteStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("MortaredStone")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class MortaredGraniteStacked3Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 MortaredGranite
}
