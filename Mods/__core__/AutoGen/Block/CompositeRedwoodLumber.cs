...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeRedwoodLumber".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Blocks", "Building Materials", subPageName: "Composite Redwood Lumber Item")]
    public partial class CompositeRedwoodLumberRecipe : Recipe
    {
        public CompositeRedwoodLumberRecipe()
        {
            this.Init(
                name: "CompositeRedwoodLumber",  //noloc
                displayName: Localizer.DoStr("Composite Redwood Lumber"),
    ...
    [RequiresSkill(typeof(CompositesSkill), 1)]
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(CompositeRedwoodLumberItem); } }
    }
    ...
    [Serialized, Solid] public class CompositeRedwoodLumberStacked1Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeRedwoodLumberStacked2Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.PartialStack)]
    [Serialized, Solid] public class CompositeRedwoodLumberStacked3Block : PickupableBlock, IWaterLoggedBlock { }
    [Tag("CompositeLumber")]
    [Tag("SoftwoodLumber")]
    [Tag("Constructable")]
    [Tag(BlockTags.FullStack)]
    [Serialized, Solid,Wall] public class CompositeRedwoodLumberStacked4Block : PickupableBlock, IWaterLoggedBlock { } //Only a wall if it's all 4 CompositeRedwoodLumber
}
