...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PulpFillerRecipe : RecipeFamily
    {
        public PulpFillerRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PulpFillerRecipe), start: 0.3f, skillType: typeof(FertilizersSkill), typeof(FertilizersFocusedSpeedTalent), typeof(FertilizersParallelSpeedTalent));
