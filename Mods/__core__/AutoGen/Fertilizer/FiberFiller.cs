...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Fertilizers", subPageName: "Fiber Filler Item")]
    public partial class FiberFillerRecipe : RecipeFamily
    {
        public FiberFillerRecipe()
        {
            ...
            recipe.Init(
                name: "FiberFiller",  //noloc
                displayName: Localizer.DoStr("Fiber Filler"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FiberFillerRecipe), start: 0.3f, skillType: typeof(FertilizersSkill), typeof(FertilizersFocusedSpeedTalent), typeof(FertilizersParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Fiber Filler"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fiber Filler"), recipeType: typeof(FiberFillerRecipe));
    ...
    [LocDescription("A filler ingredient used in a variety of fertilizers.")] //The tooltip description for the item.
    [Weight(500)] // Defines how heavy FiberFiller is.
    ...
    public partial class FiberFillerItem : FertilizerItem
    {
        ...
        public override FertilizerNutrients Nutrients => new FertilizerNutrients(0.3f, 0.4f, 0.2f);
    }
}
