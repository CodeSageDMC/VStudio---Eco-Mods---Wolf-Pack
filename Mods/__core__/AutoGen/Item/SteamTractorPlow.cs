...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteamTractorPlowItem : VehicleToolItem    {
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, MechanicsSkill.MultiplicativeStrategy, typeof(MechanicsSkill), typeof(SteamTractorPlowItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
