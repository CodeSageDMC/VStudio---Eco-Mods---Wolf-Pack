...
namespace Eco.Mods.TechTree
{
    ...
    public partial class DowelRecipe : RecipeFamily
    {
        public DowelRecipe()
        {
            ...
            recipe.Init(
                name: "Dowel",  //noloc
                displayName: Localizer.DoStr("Dowel"),
                ...
                {
                    new CraftingElement<DowelItem>(16)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(DowelRecipe), start: 0.4f, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Dowel"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Dowel"), recipeType: typeof(DowelRecipe));
