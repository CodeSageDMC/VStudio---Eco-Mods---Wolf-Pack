...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WetBrick".</para>
    ...
    public partial class WetBrickRecipe : RecipeFamily
    {
        public WetBrickRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WetBrickRecipe), start: 0.5f, skillType: typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wet Brick"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wet Brick"), recipeType: typeof(WetBrickRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "WetBrick" item.</para>
    ...
    [LocDisplayName("Wet Brick")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy WetBrick is.
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    [LocDescription("A simple wet brick ready to be processed into a construction block.")] //The tooltip description for the item.
    public partial class WetBrickItem : Item    {
