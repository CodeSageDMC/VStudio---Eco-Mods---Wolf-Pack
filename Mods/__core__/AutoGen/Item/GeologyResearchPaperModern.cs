...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "GeologyResearchPaperModern".</para>
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Geology Research Paper Modern Item")]
    public partial class GeologyResearchPaperModernRecipe : RecipeFamily
    {
        public GeologyResearchPaperModernRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "GeologyResearchPaperModern",  //noloc
            ...
            this.Initialize(displayText: Localizer.DoStr("Geology Research Paper Modern"), recipeType: typeof(GeologyResearchPaperModernRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "GeologyResearchPaperModern" item.</para>
    ...
    [LocDisplayName("Geology Research Paper Modern")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy GeologyResearchPaperModern is.
    ...
    public partial class GeologyResearchPaperModernItem : Item    {
