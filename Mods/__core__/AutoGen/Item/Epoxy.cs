...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Epoxy".</para>
    ...
    public partial class EpoxyRecipe : RecipeFamily
    {
        public EpoxyRecipe()
        {
            ...
            recipe.Init(
                name: "Epoxy",  //noloc
                displayName: Localizer.DoStr("Epoxy"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(EpoxyRecipe), start: 1.5f, skillType: typeof(OilDrillingSkill), typeof(OilDrillingFocusedSpeedTalent), typeof(OilDrillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Epoxy"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Epoxy"), recipeType: typeof(EpoxyRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "Epoxy" item.</para>
    ...
    [LocDisplayName("Epoxy")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy Epoxy is.
