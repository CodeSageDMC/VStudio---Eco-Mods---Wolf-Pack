...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Engineering Research Paper Modern Item")]
    public partial class EngineeringResearchPaperModernRecipe : RecipeFamily
    {
        public EngineeringResearchPaperModernRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "EngineeringResearchPaperModern",  //noloc
                displayName: Localizer.DoStr("Engineering Research Paper Modern"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(IronAxleItem), 8, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Engineering Research Paper Modern"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Engineering Research Paper Modern"), recipeType: typeof(EngineeringResearchPaperModernRecipe));
    ...
    [LocDisplayName("Engineering Research Paper Modern")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy EngineeringResearchPaperModern is.
    ...
    public partial class EngineeringResearchPaperModernItem : Item    {
