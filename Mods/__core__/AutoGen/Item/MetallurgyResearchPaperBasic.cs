...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Metallurgy Research Paper Basic Item")]
    public partial class MetallurgyResearchPaperBasicRecipe : RecipeFamily
    {
        public MetallurgyResearchPaperBasicRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Metallurgy Research Paper Basic"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Ore", 10, typeof(MiningSkill)), //noloc
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Metallurgy Research Paper Basic"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Metallurgy Research Paper Basic"), recipeType: typeof(MetallurgyResearchPaperBasicRecipe));
    ...
    [LocDisplayName("Metallurgy Research Paper Basic")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy MetallurgyResearchPaperBasic is.
    ...
    public partial class MetallurgyResearchPaperBasicItem : Item    {
