...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteamTractorHarvesterItem : VehicleToolItem    {
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, MechanicsSkill.MultiplicativeStrategy, typeof(MechanicsSkill), typeof(SteamTractorHarvesterItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
