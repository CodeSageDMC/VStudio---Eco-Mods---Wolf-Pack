...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Culinary Research Paper Advanced Item")]
    public partial class CulinaryResearchPaperAdvancedRecipe : RecipeFamily
    {
        public CulinaryResearchPaperAdvancedRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Culinary Research Paper Advanced"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("BakedVegetable", 16, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)), //noloc
                    new IngredientElement("Salad", 10, typeof(CookingSkill), typeof(CookingLavishResourcesTalent)), //noloc
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Culinary Research Paper Advanced"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Culinary Research Paper Advanced"), recipeType: typeof(CulinaryResearchPaperAdvancedRecipe));
    ...
    [LocDisplayName("Culinary Research Paper Advanced")] // Defines the localized name of the item.
    ...
    public partial class CulinaryResearchPaperAdvancedItem : Item    {
