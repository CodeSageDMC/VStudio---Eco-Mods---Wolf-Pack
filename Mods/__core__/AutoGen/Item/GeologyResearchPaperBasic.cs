...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Geology Research Paper Basic Item")]
    public partial class GeologyResearchPaperBasicRecipe : RecipeFamily
    {
        public GeologyResearchPaperBasicRecipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Geology Research Paper Basic"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Rock", 30, typeof(MiningSkill)), //noloc
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Geology Research Paper Basic"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Geology Research Paper Basic"), recipeType: typeof(GeologyResearchPaperBasicRecipe));
    ...
    [LocDisplayName("Geology Research Paper Basic")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy GeologyResearchPaperBasic is.
    ...
    public partial class GeologyResearchPaperBasicItem : Item    {
