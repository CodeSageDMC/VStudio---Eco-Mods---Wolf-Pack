...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdvancedCircuit".</para>
    ...
    [Ecopedia("Items", "Products", subPageName: "Advanced Circuit Item")]
    public partial class AdvancedCircuitRecipe : RecipeFamily
    {
        public AdvancedCircuitRecipe()
        {
            ...
            recipe.Init(
                name: "AdvancedCircuit",  //noloc
                displayName: Localizer.DoStr("Advanced Circuit"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedCircuitRecipe), start: 0.8f, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Advanced Circuit"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Advanced Circuit"), recipeType: typeof(AdvancedCircuitRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "AdvancedCircuit" item.</para>
    ...
    [LocDisplayName("Advanced Circuit")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy AdvancedCircuit is.
    ...
    public partial class AdvancedCircuitItem : PartItem    {
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, ElectronicsSkill.MultiplicativeStrategy, typeof(ElectronicsSkill), typeof(AdvancedCircuitItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
