...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Items", "Research Papers", subPageName: "Metallurgy Research Paper Modern Item")]
    public partial class MetallurgyResearchPaperModernRecipe : RecipeFamily
    {
        public MetallurgyResearchPaperModernRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "MetallurgyResearchPaperModern",  //noloc
                displayName: Localizer.DoStr("Metallurgy Research Paper Modern"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(RebarItem), 6, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Metallurgy Research Paper Modern"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Metallurgy Research Paper Modern"), recipeType: typeof(MetallurgyResearchPaperModernRecipe));
    ...
    [LocDisplayName("Metallurgy Research Paper Modern")] // Defines the localized name of the item.
    [Weight(10)] // Defines how heavy MetallurgyResearchPaperModern is.
    ...
    public partial class MetallurgyResearchPaperModernItem : Item    {
