...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Gearbox".</para>
    ...
    [Ecopedia("Items", "Products", subPageName: "Gearbox Item")]
    public partial class GearboxRecipe : RecipeFamily
    {
        public GearboxRecipe()
        {
            ...
            recipe.Init(
                name: "Gearbox",  //noloc
                displayName: Localizer.DoStr("Gearbox"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(LubricantItem), 1, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GearboxRecipe), start: 1.5f, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Gearbox"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Gearbox"), recipeType: typeof(GearboxRecipe));
    ...
    [Weight(500)] // Defines how heavy Gearbox is.
    ...
    public partial class GearboxItem : PartItem    {
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, MechanicsSkill.MultiplicativeStrategy, typeof(MechanicsSkill), typeof(GearboxItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
