...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CulinaryResearchPaperModernRecipe : RecipeFamily
    {
        public CulinaryResearchPaperModernRecipe()
        {
            ...
            recipe.Init(
                name: "CulinaryResearchPaperModern",  //noloc
                displayName: Localizer.DoStr("Culinary Research Paper Modern"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Culinary Research Paper Modern"), recipeType: typeof(CulinaryResearchPaperModernRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "CulinaryResearchPaperModern" item.</para>
    ...
    [LocDisplayName("Culinary Research Paper Modern")] // Defines the localized name of the item.
