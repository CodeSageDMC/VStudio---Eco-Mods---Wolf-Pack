...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdvancedUpgradeLvl3".</para>
    ...
    [Ecopedia("Upgrade Modules", "Advanced Upgrades", subPageName: "Advanced Upgrade 3 Item")]
    public partial class AdvancedUpgradeLvl3Recipe : RecipeFamily
    {
        public AdvancedUpgradeLvl3Recipe()
        {
            ...
            recipe.Init(
                name: "AdvancedUpgradeLvl3",  //noloc
                displayName: Localizer.DoStr("Advanced Upgrade 3"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(MetallurgyResearchPaperAdvancedItem), 1, true),
                    new IngredientElement(typeof(CulinaryResearchPaperAdvancedItem), 1, true),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedUpgradeLvl3Recipe), start: 9, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Advanced Upgrade 3"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Advanced Upgrade 3"), recipeType: typeof(AdvancedUpgradeLvl3Recipe));
