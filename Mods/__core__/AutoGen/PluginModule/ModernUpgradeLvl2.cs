...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernUpgradeLvl2".</para>
    ...
    [Ecopedia("Upgrade Modules", "Modern Upgrades", subPageName: "Modern Upgrade 2 Item")]
    public partial class ModernUpgradeLvl2Recipe : RecipeFamily
    {
        public ModernUpgradeLvl2Recipe()
        {
            ...
            recipe.Init(
                name: "ModernUpgradeLvl2",  //noloc
                displayName: Localizer.DoStr("Modern Upgrade 2"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(SteelGearItem), 5, true),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernUpgradeLvl2Recipe), start: 6, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Modern Upgrade 2"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Modern Upgrade 2"), recipeType: typeof(ModernUpgradeLvl2Recipe));
