...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernUpgradeLvl1".</para>
    ...
    [Ecopedia("Upgrade Modules", "Modern Upgrades", subPageName: "Modern Upgrade 1 Item")]
    public partial class ModernUpgradeLvl1Recipe : RecipeFamily
    {
        public ModernUpgradeLvl1Recipe()
        {
            ...
            recipe.Init(
                name: "ModernUpgradeLvl1",  //noloc
                displayName: Localizer.DoStr("Modern Upgrade 1"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(SteelBarItem), 3, true),
                    new IngredientElement(typeof(RivetItem), 10, true),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernUpgradeLvl1Recipe), start: 2, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Modern Upgrade 1"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Modern Upgrade 1"), recipeType: typeof(ModernUpgradeLvl1Recipe));
