...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "AdvancedUpgradeLvl4".</para>
    ...
    [Ecopedia("Upgrade Modules", "Advanced Upgrades", subPageName: "Advanced Upgrade 4 Item")]
    public partial class AdvancedUpgradeLvl4Recipe : RecipeFamily
    {
        public AdvancedUpgradeLvl4Recipe()
        {
            ...
            recipe.Init(
                name: "AdvancedUpgradeLvl4",  //noloc
                displayName: Localizer.DoStr("Advanced Upgrade 4"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(DendrologyResearchPaperModernItem), 1, true),
                    new IngredientElement(typeof(EngineeringResearchPaperModernItem), 1, true),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(AdvancedUpgradeLvl4Recipe), start: 12, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Advanced Upgrade 4"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Advanced Upgrade 4"), recipeType: typeof(AdvancedUpgradeLvl4Recipe));
