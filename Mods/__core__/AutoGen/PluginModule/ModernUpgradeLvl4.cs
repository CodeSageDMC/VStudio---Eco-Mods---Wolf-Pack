...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernUpgradeLvl4".</para>
    ...
    [Ecopedia("Upgrade Modules", "Modern Upgrades", subPageName: "Modern Upgrade 4 Item")]
    public partial class ModernUpgradeLvl4Recipe : RecipeFamily
    {
        public ModernUpgradeLvl4Recipe()
        {
            ...
            recipe.Init(
                name: "ModernUpgradeLvl4",  //noloc
                displayName: Localizer.DoStr("Modern Upgrade 4"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(PlasticItem), 7, true),
                    new IngredientElement(typeof(EpoxyItem), 5, true),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernUpgradeLvl4Recipe), start: 14, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Modern Upgrade 4"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Modern Upgrade 4"), recipeType: typeof(ModernUpgradeLvl4Recipe));
