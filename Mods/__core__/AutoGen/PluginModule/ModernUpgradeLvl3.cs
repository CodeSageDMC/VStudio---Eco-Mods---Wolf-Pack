...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernUpgradeLvl3".</para>
    ...
    [Ecopedia("Upgrade Modules", "Modern Upgrades", subPageName: "Modern Upgrade 3 Item")]
    public partial class ModernUpgradeLvl3Recipe : RecipeFamily
    {
        public ModernUpgradeLvl3Recipe()
        {
            ...
            recipe.Init(
                name: "ModernUpgradeLvl3",  //noloc
                displayName: Localizer.DoStr("Modern Upgrade 3"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernUpgradeLvl3Recipe), start: 10, skillType: typeof(SelfImprovementSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Modern Upgrade 3"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Modern Upgrade 3"), recipeType: typeof(ModernUpgradeLvl3Recipe));
