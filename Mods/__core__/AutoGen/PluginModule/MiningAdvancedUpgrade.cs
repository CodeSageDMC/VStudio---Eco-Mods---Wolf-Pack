...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MiningAdvancedUpgrade".</para>
    ...
    [Ecopedia("Upgrade Modules", "Specialty Upgrades", subPageName: "Mining Advanced Upgrade Item")]
    public partial class MiningAdvancedUpgradeRecipe : RecipeFamily
    {
        public MiningAdvancedUpgradeRecipe()
        {
            ...
            recipe.Init(
                name: "MiningAdvancedUpgrade",  //noloc
                displayName: Localizer.DoStr("Mining Advanced Upgrade"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MiningAdvancedUpgradeRecipe), start: 15, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Mining Advanced Upgrade"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Mining Advanced Upgrade"), recipeType: typeof(MiningAdvancedUpgradeRecipe));
    ...
    [LocDescription("Advanced Upgrade that greatly increases efficiency when crafting Mining recipes.")]
    [Weight(1)]
