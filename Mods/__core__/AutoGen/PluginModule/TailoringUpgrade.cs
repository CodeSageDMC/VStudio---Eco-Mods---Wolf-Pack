...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TailoringUpgrade".</para>
    ...
    [Ecopedia("Upgrade Modules", "Specialty Upgrades", subPageName: "Tailoring Basic Upgrade Item")]
    public partial class TailoringUpgradeRecipe : RecipeFamily
    {
        public TailoringUpgradeRecipe()
        {
            ...
            recipe.Init(
                name: "TailoringUpgrade",  //noloc
                displayName: Localizer.DoStr("Tailoring Basic Upgrade"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TailoringUpgradeRecipe), start: 10, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Tailoring Basic Upgrade"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Tailoring Basic Upgrade"), recipeType: typeof(TailoringUpgradeRecipe));
    ...
    [LocDescription("Basic Upgrade that greatly increases efficiency when crafting Tailoring recipes.")]
    [Weight(1)]
