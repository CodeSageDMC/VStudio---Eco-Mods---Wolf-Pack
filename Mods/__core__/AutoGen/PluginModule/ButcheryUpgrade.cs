...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ButcheryUpgrade".</para>
    ...
    [Ecopedia("Upgrade Modules", "Specialty Upgrades", subPageName: "Butchery Upgrade Item")]
    public partial class ButcheryUpgradeRecipe : RecipeFamily
    {
        public ButcheryUpgradeRecipe()
        {
            ...
            recipe.Init(
                name: "ButcheryUpgrade",  //noloc
                displayName: Localizer.DoStr("Butchery Upgrade"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Butchery Upgrade"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Butchery Upgrade"), recipeType: typeof(ButcheryUpgradeRecipe));
    ...
    [LocDescription("Basic Upgrade that greatly increases efficiency when crafting Butchery recipes.")]
    [Weight(1)]
