...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Stone Brazier Item")]
    ...
    [LocDescription("A stone stand which can hold burning fuel to provide light.")]
    [Ecopedia("Housing Objects", "Outdoor", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy StoneBrazier is.
        ...
        public partial class StoneBrazierItem : WorldObjectItem<StoneBrazierObject>
    {
        ...
        {
            ObjectName                              = typeof(StoneBrazierObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "StoneBrazier".</para>
    ...
    public partial class StoneBrazierRecipe : RecipeFamily
    {
        public StoneBrazierRecipe()
        {
            ...
            recipe.Init(
                name: "StoneBrazier",  //noloc
                displayName: Localizer.DoStr("Stone Brazier"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Rock", 15, typeof(MasonrySkill), typeof(MasonryLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(StoneBrazierRecipe), start: 4, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Stone Brazier"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stone Brazier"), recipeType: typeof(StoneBrazierRecipe));
            this.ModsPostInitialize();
