...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(6)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Redwood Bench Item")]
            public partial class CompositeRedwoodBenchObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeRedwoodBenchItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Redwood Bench");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeRedwoodBenchItem.homeValue;
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy CompositeRedwoodBench is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
        public partial class CompositeRedwoodBenchItem : WorldObjectItem<CompositeRedwoodBenchObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeRedwoodBenchObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeRedwoodBench".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Redwood Bench Item")]
    public partial class CompositeRedwoodBenchRecipe : Recipe
    {
        public CompositeRedwoodBenchRecipe()
        {
            this.Init(
                name: "CompositeRedwoodBench",  //noloc
                displayName: Localizer.DoStr("Composite Redwood Bench"),
