...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Lathe Item")]
    [RepairRequiresSkill(typeof(MechanicsSkill), 1)]
            [RepairRequiresSkill(typeof(SelfImprovementSkill), 5)]   
                  public partial class LatheObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(LatheItem);
        public override LocString DisplayName => Localizer.DoStr("Lathe");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = LatheItem.homeValue;
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Lathe".</para>
    ...
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Lathe Item")]
    public partial class LatheRecipe : RecipeFamily
    {
        public LatheRecipe()
        {
            ...
            recipe.Init(
                name: "Lathe",  //noloc
                displayName: Localizer.DoStr("Lathe"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LatheRecipe), start: 5, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Lathe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Lathe"), recipeType: typeof(LatheRecipe));
            this.ModsPostInitialize();
