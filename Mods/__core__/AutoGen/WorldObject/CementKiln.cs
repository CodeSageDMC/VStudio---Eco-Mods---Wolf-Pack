...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomMaterialTier(2.8f, typeof(MasonryLavishReqTalent), typeof(MasonryFrugalReqTalent))]
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Cement Kiln Item")]
                  ...
                  public partial class CementKilnObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.ModsPostInitialize();
            {
                ...
                {
                                        new() { TypeName = nameof(IronPlateItem), Quantity = 2},
    ...
    [Weight(5000)] // Defines how heavy CementKiln is.
    ...
    public partial class CementKilnItem : WorldObjectItem<CementKilnObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(CementKilnObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CementKiln".</para>
    ...
    public partial class CementKilnRecipe : RecipeFamily
    {
        public CementKilnRecipe()
        {
            ...
            recipe.Init(
                name: "CementKiln",  //noloc
                displayName: Localizer.DoStr("Cement Kiln"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CementKilnRecipe), start: 100, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cement Kiln"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cement Kiln"), recipeType: typeof(CementKilnRecipe));
            this.ModsPostInitialize();
