...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bedroom", subPageName: "Wooden Fabric Bed Item")]
    ...
    [LocDescription("A much more comfortable bed made with fabric.")]
    [Ecopedia("Housing Objects", "Bedroom", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(2000)] // Defines how heavy WoodenFabricBed is.
        ...
        public partial class WoodenFabricBedItem : WorldObjectItem<WoodenFabricBedObject>
    {
        ...
        {
            ObjectName                              = typeof(WoodenFabricBedObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WoodenFabricBed".</para>
    ...
    public partial class WoodenFabricBedRecipe : RecipeFamily
    {
        public WoodenFabricBedRecipe()
        {
            ...
            recipe.Init(
                name: "WoodenFabricBed",  //noloc
                displayName: Localizer.DoStr("Wooden Fabric Bed"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WoodenFabricBedRecipe), start: 6, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wooden Fabric Bed"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wooden Fabric Bed"), recipeType: typeof(WoodenFabricBedRecipe));
            this.ModsPostInitialize();
