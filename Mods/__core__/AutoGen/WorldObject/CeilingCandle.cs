...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CeilingCandleRecipe : RecipeFamily
    {
        public CeilingCandleRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CeilingCandleRecipe), start: 4, skillType: typeof(BlacksmithSkill), typeof(BlacksmithFocusedSpeedTalent), typeof(BlacksmithParallelSpeedTalent));
