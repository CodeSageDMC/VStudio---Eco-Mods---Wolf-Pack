...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Specialty", subPageName: "Waste Filter Item")]
            public partial class WasteFilterObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(WasteFilterItem);
        public override LocString DisplayName => Localizer.DoStr("Waste Filter");
    ...
    [Weight(5000)] // Defines how heavy WasteFilter is.
            public partial class WasteFilterItem : WorldObjectItem<WasteFilterObject>, IPersistentData
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WasteFilter".</para>
    ...
    public partial class WasteFilterRecipe : RecipeFamily
    {
        public WasteFilterRecipe()
        {
            ...
            recipe.Init(
                name: "WasteFilter",  //noloc
                displayName: Localizer.DoStr("Waste Filter"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WasteFilterRecipe), start: 20, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Waste Filter"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Waste Filter"), recipeType: typeof(WasteFilterRecipe));
            this.ModsPostInitialize();
