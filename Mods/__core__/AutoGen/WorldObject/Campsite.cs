...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Campsite Item")]
    ...
    [LocDescription("A campsite.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [StartsDiscovered]
    [Weight(2000)] // Defines how heavy Campsite is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Campsite".</para>
    ...
    public partial class CampsiteRecipe : RecipeFamily
    {
        public CampsiteRecipe()
        {
            ...
            recipe.Init(
                name: "Campsite",  //noloc
                displayName: Localizer.DoStr("Campsite"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CampsiteRecipe), start: 2, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Campsite"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Campsite"), recipeType: typeof(CampsiteRecipe));
            this.ModsPostInitialize();
