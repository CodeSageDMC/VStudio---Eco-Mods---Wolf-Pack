...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Hewn Table Item")]
    ...
    [LocDescription("A large table for placing things on.")]
    [Ecopedia("Housing Objects", "Seating", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy HewnTable is.
        ...
        public partial class HewnTableItem : WorldObjectItem<HewnTableObject>
    {
        ...
        {
            ObjectName                              = typeof(HewnTableObject).UILink(),
    ...
    public partial class HewnTableRecipe : RecipeFamily
    {
        public HewnTableRecipe()
        {
            ...
            recipe.Init(
                name: "HewnTable",  //noloc
                displayName: Localizer.DoStr("Hewn Table"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(HewnTableRecipe), start: 4, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Hewn Table"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Hewn Table"), recipeType: typeof(HewnTableRecipe));
            this.ModsPostInitialize();
