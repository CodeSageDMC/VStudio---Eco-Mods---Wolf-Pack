...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Government", subPageName: "Amendments Item")]
    ...
    [LocDescription("Allows the modification of the constitution.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Government", createAsSubPage: true)]
    [Weight(2000)] // Defines how heavy Amendments is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Amendments".</para>
    ...
    public partial class AmendmentsRecipe : RecipeFamily
    {
        public AmendmentsRecipe()
        {
            ...
            recipe.Init(
                name: "Amendments",  //noloc
                displayName: Localizer.DoStr("Amendments"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Amendments"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Amendments"), recipeType: typeof(AmendmentsRecipe));
            this.ModsPostInitialize();
