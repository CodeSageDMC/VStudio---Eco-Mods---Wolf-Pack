...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Living Room", subPageName: "Padded Chair Item")]
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy PaddedChair is.
        ...
        public partial class PaddedChairItem : WorldObjectItem<PaddedChairObject>
    {
        ...
        {
            ObjectName                              = typeof(PaddedChairObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PaddedChair".</para>
    ...
    public partial class PaddedChairRecipe : RecipeFamily
    {
        public PaddedChairRecipe()
        {
            ...
            recipe.Init(
                name: "PaddedChair",  //noloc
                displayName: Localizer.DoStr("Padded Chair"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PaddedChairRecipe), start: 8, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Padded Chair"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Padded Chair"), recipeType: typeof(PaddedChairRecipe));
            this.ModsPostInitialize();
