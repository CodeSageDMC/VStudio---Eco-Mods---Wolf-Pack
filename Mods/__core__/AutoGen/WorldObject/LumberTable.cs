...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Lumber Table Item")]
    ...
    [LocDescription("A large lumber table for eating meals or getting some work done.")]
    [Ecopedia("Housing Objects", "Seating", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(2000)] // Defines how heavy LumberTable is.
        ...
        public partial class LumberTableItem : WorldObjectItem<LumberTableObject>
    {
        ...
        {
            ObjectName                              = typeof(LumberTableObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LumberTable".</para>
    ...
    public partial class LumberTableRecipe : RecipeFamily
    {
        public LumberTableRecipe()
        {
            ...
            recipe.Init(
                name: "LumberTable",  //noloc
                displayName: Localizer.DoStr("Lumber Table"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LumberTableRecipe), start: 4, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Lumber Table"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Lumber Table"), recipeType: typeof(LumberTableRecipe));
            this.ModsPostInitialize();
