...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Tag("LargeDoor")]
    [Ecopedia("Housing Objects", "Doors", subPageName: "Large Windowed Lumber Door Item")]
    ...
    [LocDescription("A large lumber door with windows allowing moderate sized vehicles through..")]
    [IconGroup("World Object Minimap")]
    [Tier(3)]
    [Ecopedia("Housing Objects", "Doors", createAsSubPage: true)]
    [Weight(2000)] // Defines how heavy LargeWindowedLumberDoor is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LargeWindowedLumberDoor".</para>
    ...
    public partial class LargeWindowedLumberDoorRecipe : RecipeFamily
    {
        public LargeWindowedLumberDoorRecipe()
        {
            ...
            recipe.Init(
                name: "LargeWindowedLumberDoor",  //noloc
                displayName: Localizer.DoStr("Large Windowed Lumber Door"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LargeWindowedLumberDoorRecipe), start: 10, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Large Windowed Lumber Door"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Large Windowed Lumber Door"), recipeType: typeof(LargeWindowedLumberDoorRecipe));
            this.ModsPostInitialize();
