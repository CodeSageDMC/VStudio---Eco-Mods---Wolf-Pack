...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(2)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bathroom", subPageName: "Small Bath Mat Item")]
    ...
    [Tag("Housing")]
    [Weight(250)] // Defines how heavy SmallBathMat is.
            public partial class SmallBathMatItem : WorldObjectItem<SmallBathMatObject>
    {
        ...
        {
            ObjectName                              = typeof(SmallBathMatObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmallBathMat".</para>
    ...
    public partial class SmallBathMatRecipe : RecipeFamily
    {
        public SmallBathMatRecipe()
        {
            ...
            recipe.Init(
                name: "SmallBathMat",  //noloc
                displayName: Localizer.DoStr("Small Bath Mat"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SmallBathMatRecipe), start: 4, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Small Bath Mat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Small Bath Mat"), recipeType: typeof(SmallBathMatRecipe));
            this.ModsPostInitialize();
