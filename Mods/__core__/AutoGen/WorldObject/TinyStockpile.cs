...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Storage", subPageName: "Tiny Stockpile Item")]
    ...
    [Weight(500)] // Defines how heavy TinyStockpile is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TinyStockpile".</para>
    ...
    public partial class TinyStockpileRecipe : RecipeFamily
    {
        public TinyStockpileRecipe()
        {
            ...
            recipe.Init(
                name: "TinyStockpile",  //noloc
                displayName: Localizer.DoStr("Tiny Stockpile"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Tiny Stockpile"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Tiny Stockpile"), recipeType: typeof(TinyStockpileRecipe));
            this.ModsPostInitialize();
