...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(6)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Softwood Lumber Bench Item")]
            public partial class SoftwoodLumberBenchObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(SoftwoodLumberBenchItem);
        public override LocString DisplayName => Localizer.DoStr("Softwood Lumber Bench");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = SoftwoodLumberBenchItem.homeValue;
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy SoftwoodLumberBench is.
        ...
        public partial class SoftwoodLumberBenchItem : WorldObjectItem<SoftwoodLumberBenchObject>
    {
        ...
        {
            ObjectName                              = typeof(SoftwoodLumberBenchObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SoftwoodLumberBench".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Softwood Lumber Bench Item")]
    public partial class SoftwoodLumberBenchRecipe : Recipe
    {
        public SoftwoodLumberBenchRecipe()
        {
            this.Init(
                name: "SoftwoodLumberBench",  //noloc
                displayName: Localizer.DoStr("Softwood Lumber Bench"),
