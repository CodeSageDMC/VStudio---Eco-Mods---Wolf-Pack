...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(2)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Kitchen", subPageName: "Wooden Kitchen Lamp Item")]
            public partial class WoodenKitchenLampObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(WoodenKitchenLampItem);
        public override LocString DisplayName => Localizer.DoStr("Wooden Kitchen Lamp");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = WoodenKitchenLampItem.homeValue;
    ...
    [Serialized]
    [LocDisplayName("Wooden Kitchen Lamp")]
    [LocDescription("A more modern way to light up a room.")]
    [Ecopedia("Housing Objects", "Kitchen", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy WoodenKitchenLamp is.
        [Tag(nameof(SurfaceTags.CanBeOnTableTop))] 
    public partial class WoodenKitchenLampItem : WorldObjectItem<WoodenKitchenLampObject>
    {
        ...
        {
            ObjectName                              = typeof(WoodenKitchenLampObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WoodenKitchenLamp".</para>
    ...
    [Ecopedia("Housing Objects", "Kitchen", subPageName: "Wooden Kitchen Lamp Item")]
    public partial class WoodenKitchenLampRecipe : RecipeFamily
    {
        public WoodenKitchenLampRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "WoodenKitchenLamp",  //noloc
                displayName: Localizer.DoStr("Wooden Kitchen Lamp"),
                ...
                {
                    new CraftingElement<WoodenKitchenLampItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WoodenKitchenLampRecipe), start: 4, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wooden Kitchen Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wooden Kitchen Lamp"), recipeType: typeof(WoodenKitchenLampRecipe));
            this.ModsPostInitialize();
