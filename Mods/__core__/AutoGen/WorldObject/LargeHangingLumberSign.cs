...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Hanging Lumber Sign Item")]
    ...
    [Weight(2000)] // Defines how heavy LargeHangingLumberSign is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LargeHangingLumberSign".</para>
    ...
    public partial class LargeHangingLumberSignRecipe : RecipeFamily
    {
        public LargeHangingLumberSignRecipe()
        {
            ...
            recipe.Init(
                name: "LargeHangingLumberSign",  //noloc
                displayName: Localizer.DoStr("Large Hanging Lumber Sign"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LargeHangingLumberSignRecipe), start: 5, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Large Hanging Lumber Sign"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Large Hanging Lumber Sign"), recipeType: typeof(LargeHangingLumberSignRecipe));
            this.ModsPostInitialize();
