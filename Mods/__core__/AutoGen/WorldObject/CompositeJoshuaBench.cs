...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(6)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Joshua Bench Item")]
            public partial class CompositeJoshuaBenchObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeJoshuaBenchItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Joshua Bench");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeJoshuaBenchItem.homeValue;
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy CompositeJoshuaBench is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
        public partial class CompositeJoshuaBenchItem : WorldObjectItem<CompositeJoshuaBenchObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeJoshuaBenchObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeJoshuaBench".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Joshua Bench Item")]
    public partial class CompositeJoshuaBenchRecipe : Recipe
    {
        public CompositeJoshuaBenchRecipe()
        {
            this.Init(
                name: "CompositeJoshuaBench",  //noloc
                displayName: Localizer.DoStr("Composite Joshua Bench"),
