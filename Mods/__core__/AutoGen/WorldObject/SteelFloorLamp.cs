...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Floor Lamp Item")]
            public partial class SteelFloorLampObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(SteelFloorLampItem);
        public override LocString DisplayName => Localizer.DoStr("Steel Floor Lamp");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = SteelFloorLampItem.homeValue;
    ...
    [LocDescription("A more modern way to light up a room. This time from the floor.")]
    [Ecopedia("Housing Objects", "Lighting", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy SteelFloorLamp is.
        ...
        public partial class SteelFloorLampItem : WorldObjectItem<SteelFloorLampObject>
    {
        ...
        {
            ObjectName                              = typeof(SteelFloorLampObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SteelFloorLamp".</para>
    ...
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Floor Lamp Item")]
    public partial class SteelFloorLampRecipe : RecipeFamily
    {
        public SteelFloorLampRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelFloorLamp",  //noloc
                displayName: Localizer.DoStr("Steel Floor Lamp"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelFloorLampRecipe), start: 4, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Steel Floor Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steel Floor Lamp"), recipeType: typeof(SteelFloorLampRecipe));
            this.ModsPostInitialize();
