...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Ceiling Light Item")]
            public partial class SteelCeilingLightObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(SteelCeilingLightItem);
        public override LocString DisplayName => Localizer.DoStr("Steel Ceiling Light");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = SteelCeilingLightItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy SteelCeilingLight is.
            public partial class SteelCeilingLightItem : WorldObjectItem<SteelCeilingLightObject>
    {
        ...
        {
            ObjectName                              = typeof(SteelCeilingLightObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SteelCeilingLight".</para>
    ...
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Ceiling Light Item")]
    public partial class SteelCeilingLightRecipe : RecipeFamily
    {
        public SteelCeilingLightRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelCeilingLight",  //noloc
                displayName: Localizer.DoStr("Steel Ceiling Light"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelCeilingLightRecipe), start: 4, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Steel Ceiling Light"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steel Ceiling Light"), recipeType: typeof(SteelCeilingLightRecipe));
            this.ModsPostInitialize();
