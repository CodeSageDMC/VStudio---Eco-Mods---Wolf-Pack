...
namespace Eco.Mods.TechTree
{
                  ...
                  public partial class IndustrialGeneratorObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<PowerGridComponent>().Initialize(30, new ElectricPower(), 8);
            this.GetComponent<PowerGeneratorComponent>().Initialize(64000);
            ...
            this.ModsPostInitialize();
            {
                this.GetComponent<PartsComponent>().Config(() => LocString.Empty, new PartInfo[]
                {
                                        ...
                                        new() { TypeName = nameof(LubricantItem), Quantity = 14},
                                    });
    ...
    [LocDescription("A large modern generator consuming liquid fuel to generate high volumes of electricity.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Crafted Objects", "Power Generation", createAsSubPage: true)]
    [LiquidProducer(typeof(SmogItem), 1.2f)]
    [Weight(10000)] // Defines how heavy IndustrialGenerator is.
            public partial class IndustrialGeneratorItem : WorldObjectItem<IndustrialGeneratorObject>, IPersistentData
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(IndustrialGeneratorObject).UILink(),
        ...
        [NewTooltip(CacheAs.SubType, 8)] public static LocString PowerProductionTooltip()  => Localizer.Do($"Produces: {Text.Info(64000)}w of {new ElectricPower().Name} power.");
