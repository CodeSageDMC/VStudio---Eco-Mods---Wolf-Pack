...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Torch Stand Item")]
    ...
    [LocDescription("A stand for a torch.")]
    [Ecopedia("Housing Objects", "Lighting", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy TorchStand is.
        ...
        public partial class TorchStandItem : WorldObjectItem<TorchStandObject>
    {
        ...
        {
            ObjectName                              = typeof(TorchStandObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TorchStand".</para>
    ...
    public partial class TorchStandRecipe : RecipeFamily
    {
        public TorchStandRecipe()
        {
            ...
            recipe.Init(
                name: "TorchStand",  //noloc
                displayName: Localizer.DoStr("Torch Stand"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Torch Stand"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Torch Stand"), recipeType: typeof(TorchStandRecipe));
            this.ModsPostInitialize();
