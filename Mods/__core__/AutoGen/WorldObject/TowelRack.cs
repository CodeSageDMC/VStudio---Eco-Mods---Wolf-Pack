...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bathroom", subPageName: "Towel Rack Item")]
    ...
    [LocDescription("A wooden hanging rack designed for towels.")]
    [Ecopedia("Housing Objects", "Bathroom", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy TowelRack is.
        ...
        public partial class TowelRackItem : WorldObjectItem<TowelRackObject>
    {
        ...
        {
            ObjectName                              = typeof(TowelRackObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TowelRack".</para>
    ...
    public partial class TowelRackRecipe : RecipeFamily
    {
        public TowelRackRecipe()
        {
            ...
            recipe.Init(
                name: "TowelRack",  //noloc
                displayName: Localizer.DoStr("Towel Rack"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TowelRackRecipe), start: 4, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Towel Rack"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Towel Rack"), recipeType: typeof(TowelRackRecipe));
            this.ModsPostInitialize();
