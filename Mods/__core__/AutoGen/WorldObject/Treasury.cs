...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Government", subPageName: "Treasury Item")]
    ...
    [LocDescription("Allows the setting of taxes.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Government", createAsSubPage: true)]
    [Weight(5000)] // Defines how heavy Treasury is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Treasury".</para>
    ...
    public partial class TreasuryRecipe : RecipeFamily
    {
        public TreasuryRecipe()
        {
            ...
            recipe.Init(
                name: "Treasury",  //noloc
                displayName: Localizer.DoStr("Treasury"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(BrickItem), 8,typeof(Skill)),
                    new IngredientElement(typeof(GoldBarItem), 6,typeof(Skill)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(25);

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Treasury"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Treasury"), recipeType: typeof(TreasuryRecipe));
            this.ModsPostInitialize();
