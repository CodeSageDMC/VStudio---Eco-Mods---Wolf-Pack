...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Workbench Item")]
            public partial class WorkbenchObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(WorkbenchItem);
        public override LocString DisplayName => Localizer.DoStr("Workbench");
    ...
    /// </remarks>
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Workbench Item")]
    public partial class WorkbenchRecipe : RecipeFamily
    {
        public WorkbenchRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Workbench",  //noloc
                displayName: Localizer.DoStr("Workbench"),
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Workbench"), recipeType: typeof(WorkbenchRecipe));
            this.ModsPostInitialize();
