...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bathroom", subPageName: "Washboard Item")]
    ...
    [LocDescription("Sometimes it can be nice to have clean clothes.")]
    [Ecopedia("Housing Objects", "Bathroom", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy Washboard is.
        ...
        public partial class WashboardItem : WorldObjectItem<WashboardObject>
    {
        ...
        {
            ObjectName                              = typeof(WashboardObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Washboard".</para>
    ...
    public partial class WashboardRecipe : RecipeFamily
    {
        public WashboardRecipe()
        {
            ...
            recipe.Init(
                name: "Washboard",  //noloc
                displayName: Localizer.DoStr("Washboard"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WashboardRecipe), start: 2, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Washboard"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Washboard"), recipeType: typeof(WashboardRecipe));
            this.ModsPostInitialize();
