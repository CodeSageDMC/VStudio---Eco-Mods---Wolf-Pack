...
namespace Eco.Mods.TechTree
{
        ...
        public partial class RefrigeratorItem : WorldObjectItem<RefrigeratorObject>
    {
        ...
        {
            ObjectName                              = typeof(RefrigeratorObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Refrigerator".</para>
    ...
    public partial class RefrigeratorRecipe : RecipeFamily
    {
        public RefrigeratorRecipe()
        {
            ...
            recipe.Init(
                name: "Refrigerator",  //noloc
                displayName: Localizer.DoStr("Refrigerator"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RefrigeratorRecipe), start: 10, skillType: typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Refrigerator"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Refrigerator"), recipeType: typeof(RefrigeratorRecipe));
            this.ModsPostInitialize();
