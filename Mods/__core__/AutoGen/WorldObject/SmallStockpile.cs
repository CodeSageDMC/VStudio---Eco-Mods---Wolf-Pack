...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Storage", subPageName: "Small Stockpile Item")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmallStockpile".</para>
    ...
    public partial class SmallStockpileRecipe : RecipeFamily
    {
        public SmallStockpileRecipe()
        {
            ...
            recipe.Init(
                name: "SmallStockpile",  //noloc
                displayName: Localizer.DoStr("Small Stockpile"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Small Stockpile"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Small Stockpile"), recipeType: typeof(SmallStockpileRecipe));
            this.ModsPostInitialize();
