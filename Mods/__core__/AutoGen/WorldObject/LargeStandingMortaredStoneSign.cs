...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Standing Mortared Stone Sign Item")]
    ...
    [Weight(2000)] // Defines how heavy LargeStandingMortaredStoneSign is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LargeStandingMortaredStoneSign".</para>
    ...
    public partial class LargeStandingMortaredStoneSignRecipe : RecipeFamily
    {
        public LargeStandingMortaredStoneSignRecipe()
        {
            ...
            recipe.Init(
                name: "LargeStandingMortaredStoneSign",  //noloc
                displayName: Localizer.DoStr("Large Standing Mortared Stone Sign"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LargeStandingMortaredStoneSignRecipe), start: 5, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Large Standing Mortared Stone Sign"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Large Standing Mortared Stone Sign"), recipeType: typeof(LargeStandingMortaredStoneSignRecipe));
            this.ModsPostInitialize();
