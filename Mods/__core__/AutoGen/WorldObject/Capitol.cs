...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Government", subPageName: "Capitol Item")]
    [RelatedFeature(nameof(FeatureConfig.UseSettlementSystem),false)]
    ...
    [LocDescription("Allows the creation of the government, allowing all other civic objects to be created.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Government", createAsSubPage: true)]
    [RelatedFeature(nameof(FeatureConfig.UseSettlementSystem),false)]
    [Weight(2000)] // Defines how heavy Capitol is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Capitol".</para>
    ...
    public partial class CapitolRecipe : RecipeFamily
    {
        public CapitolRecipe()
        {
            ...
            recipe.Init(
                name: "Capitol",  //noloc
                displayName: Localizer.DoStr("Capitol"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Capitol"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Capitol"), recipeType: typeof(CapitolRecipe));
            this.ModsPostInitialize();
