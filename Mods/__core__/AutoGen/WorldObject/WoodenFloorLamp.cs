...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy WoodenFloorLamp is.
        ...
        public partial class WoodenFloorLampItem : WorldObjectItem<WoodenFloorLampObject>
    {
        ...
        {
            ObjectName                              = typeof(WoodenFloorLampObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WoodenFloorLamp".</para>
    ...
    public partial class WoodenFloorLampRecipe : RecipeFamily
    {
        public WoodenFloorLampRecipe()
        {
            ...
            recipe.Init(
                name: "WoodenFloorLamp",  //noloc
                displayName: Localizer.DoStr("Wooden Floor Lamp"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WoodenFloorLampRecipe), start: 4, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wooden Floor Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wooden Floor Lamp"), recipeType: typeof(WoodenFloorLampRecipe));
            this.ModsPostInitialize();
