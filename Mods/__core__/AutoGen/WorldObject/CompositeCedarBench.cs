...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(6)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Cedar Bench Item")]
            public partial class CompositeCedarBenchObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(CompositeCedarBenchItem);
        public override LocString DisplayName => Localizer.DoStr("Composite Cedar Bench");
        public override TableTextureMode TableTexture => TableTextureMode.Wood;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = CompositeCedarBenchItem.homeValue;
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy CompositeCedarBench is.
    [Tag(nameof(SurfaceTags.CanBeOnRug))] 
        public partial class CompositeCedarBenchItem : WorldObjectItem<CompositeCedarBenchObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(CompositeCedarBenchObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CompositeCedarBench".</para>
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Composite Cedar Bench Item")]
    public partial class CompositeCedarBenchRecipe : Recipe
    {
        public CompositeCedarBenchRecipe()
        {
            this.Init(
                name: "CompositeCedarBench",  //noloc
                displayName: Localizer.DoStr("Composite Cedar Bench"),
