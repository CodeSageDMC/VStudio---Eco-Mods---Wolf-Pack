...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Government", subPageName: "Census Bureau Item")]
    ...
    [LocDescription("Allows the creation of Demographics, which specify groups of citizens automatically based on criteria you define.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Government", createAsSubPage: true)]
    [Weight(2000)] // Defines how heavy CensusBureau is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CensusBureau".</para>
    ...
    public partial class CensusBureauRecipe : RecipeFamily
    {
        public CensusBureauRecipe()
        {
            ...
            recipe.Init(
                name: "CensusBureau",  //noloc
                displayName: Localizer.DoStr("Census Bureau"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Census Bureau"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Census Bureau"), recipeType: typeof(CensusBureauRecipe));
            this.ModsPostInitialize();
