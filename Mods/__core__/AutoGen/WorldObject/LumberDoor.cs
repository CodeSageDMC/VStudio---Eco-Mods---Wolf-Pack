...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Doors", subPageName: "Lumber Door Item")]
    ...
    [LocDescription("A door made from finely cut lumber.")]
    [IconGroup("World Object Minimap")]
    [Tier(3)]
    [Ecopedia("Housing Objects", "Doors", createAsSubPage: true)]
    [Weight(1000)] // Defines how heavy LumberDoor is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LumberDoor".</para>
    ...
    public partial class LumberDoorRecipe : RecipeFamily
    {
        public LumberDoorRecipe()
        {
            ...
            recipe.Init(
                name: "LumberDoor",  //noloc
                displayName: Localizer.DoStr("Lumber Door"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Lumber", 2, true), //noloc
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LumberDoorRecipe), start: 1, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Lumber Door"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Lumber Door"), recipeType: typeof(LumberDoorRecipe));
            this.ModsPostInitialize();
