...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Brazier Item")]
    ...
    [LocDescription("A metal stand which can hold burning fuel to provide light.")]
    [Ecopedia("Housing Objects", "Outdoor", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy Brazier is.
        ...
        public partial class BrazierItem : WorldObjectItem<BrazierObject>
    {
        ...
        {
            ObjectName                              = typeof(BrazierObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Brazier".</para>
    ...
    public partial class BrazierRecipe : RecipeFamily
    {
        public BrazierRecipe()
        {
            ...
            recipe.Init(
                name: "Brazier",  //noloc
                displayName: Localizer.DoStr("Brazier"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(TallowItem), 2, typeof(BlacksmithSkill), typeof(BlacksmithLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BrazierRecipe), start: 4, skillType: typeof(BlacksmithSkill), typeof(BlacksmithFocusedSpeedTalent), typeof(BlacksmithParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Brazier"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Brazier"), recipeType: typeof(BrazierRecipe));
            this.ModsPostInitialize();
