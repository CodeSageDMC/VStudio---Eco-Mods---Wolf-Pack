...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Table Lamp Item")]
            public partial class SteelTableLampObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(SteelTableLampItem);
        public override LocString DisplayName => Localizer.DoStr("Steel Table Lamp");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = SteelTableLampItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(500)] // Defines how heavy SteelTableLamp is.
    ...
    public partial class SteelTableLampItem : WorldObjectItem<SteelTableLampObject>
    {
        ...
        {
            ObjectName                              = typeof(SteelTableLampObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SteelTableLamp".</para>
    ...
    [Ecopedia("Housing Objects", "Lighting", subPageName: "Steel Table Lamp Item")]
    public partial class SteelTableLampRecipe : RecipeFamily
    {
        public SteelTableLampRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelTableLamp",  //noloc
                displayName: Localizer.DoStr("Steel Table Lamp"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelTableLampRecipe), start: 4, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Steel Table Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steel Table Lamp"), recipeType: typeof(SteelTableLampRecipe));
            this.ModsPostInitialize();
