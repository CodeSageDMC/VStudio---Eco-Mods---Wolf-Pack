...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Small Hanging Mortared Stone Sign Item")]
    ...
    [Weight(1000)] // Defines how heavy SmallHangingMortaredStoneSign is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmallHangingMortaredStoneSign".</para>
    ...
    public partial class SmallHangingMortaredStoneSignRecipe : RecipeFamily
    {
        public SmallHangingMortaredStoneSignRecipe()
        {
            ...
            recipe.Init(
                name: "SmallHangingMortaredStoneSign",  //noloc
                displayName: Localizer.DoStr("Small Hanging Mortared Stone Sign"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SmallHangingMortaredStoneSignRecipe), start: 5, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Small Hanging Mortared Stone Sign"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Small Hanging Mortared Stone Sign"), recipeType: typeof(SmallHangingMortaredStoneSignRecipe));
            this.ModsPostInitialize();
