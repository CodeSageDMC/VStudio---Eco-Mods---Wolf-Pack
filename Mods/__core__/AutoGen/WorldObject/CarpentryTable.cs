...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Carpentry Table Item")]
    ...
    [LocDescription("A table for basic wooden crafts for home improvement and progress.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [Weight(2000)] // Defines how heavy CarpentryTable is.
            [AllowPluginModules(Tags = new[] { "BasicUpgrade" }, ItemTypes = new[] { typeof(CarpentryBasicUpgradeItem), typeof(LoggingBasicUpgradeItem), typeof(BasicEngineeringUpgradeItem) })] //noloc
    public partial class CarpentryTableItem : WorldObjectItem<CarpentryTableObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(CarpentryTableObject).UILink(),
