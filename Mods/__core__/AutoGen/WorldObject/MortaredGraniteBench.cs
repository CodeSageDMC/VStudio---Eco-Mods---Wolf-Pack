...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(6)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Seating", subPageName: "Mortared Granite Bench Item")]
    ...
    [Tag("Housing")]
    [Tag("Mountable")]
    [Weight(1000)] // Defines how heavy MortaredGraniteBench is.
        ...
        public partial class MortaredGraniteBenchItem : WorldObjectItem<MortaredGraniteBenchObject>
    {
        ...
        {
            ObjectName                              = typeof(MortaredGraniteBenchObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MortaredGraniteBench".</para>
    ...
    public partial class MortaredGraniteBenchRecipe : Recipe
    {
        ...
        {
            this.Init(
                name: "MortaredGraniteBench",  //noloc
                displayName: Localizer.DoStr("Mortared Granite Bench"),
