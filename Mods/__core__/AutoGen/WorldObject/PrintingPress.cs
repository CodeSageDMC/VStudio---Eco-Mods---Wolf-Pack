...
namespace Eco.Mods.TechTree
{
    ...
    [RequireComponent(typeof(PicturePrinterComponent))]
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Government", subPageName: "Printing Press Item")]
    ...
    [LocDescription("The world will never be the same.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Government", createAsSubPage: true)]
    [RelatedFeature(nameof(FeatureConfig.CameraModeEnabled))]
    [Weight(5000)] // Defines how heavy PrintingPress is.
            public partial class PrintingPressItem : WorldObjectItem<PrintingPressObject>, IPersistentData
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(PrintingPressObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PrintingPress".</para>
    ...
    public partial class PrintingPressRecipe : RecipeFamily
    {
        public PrintingPressRecipe()
        {
            ...
            recipe.Init(
                name: "PrintingPress",  //noloc
                displayName: Localizer.DoStr("Printing Press"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(GearboxItem), 2, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(PrintingPressRecipe), start: 2, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Printing Press"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Printing Press"), recipeType: typeof(PrintingPressRecipe));
            this.ModsPostInitialize();
