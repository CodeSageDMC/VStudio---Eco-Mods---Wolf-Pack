...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Doors", subPageName: "Hewn Door Item")]
    ...
    [LocDescription("A door made from roughly hewn logs.")]
    [IconGroup("World Object Minimap")]
    [Tier(2)]
    [Ecopedia("Housing Objects", "Doors", createAsSubPage: true)]
    [Weight(1000)] // Defines how heavy HewnDoor is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "HewnDoor".</para>
    ...
    public partial class HewnDoorRecipe : RecipeFamily
    {
        public HewnDoorRecipe()
        {
            ...
            recipe.Init(
                name: "HewnDoor",  //noloc
                displayName: Localizer.DoStr("Hewn Door"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("HewnLog", 2, true), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(HewnDoorRecipe), start: 1, skillType: typeof(LoggingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Hewn Door"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Hewn Door"), recipeType: typeof(HewnDoorRecipe));
            this.ModsPostInitialize();
