...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Living Room", subPageName: "Mortared Stone Fireplace Item")]
    ...
    [Tag("Housing")]
    [Weight(5000)] // Defines how heavy MortaredStoneFireplace is.
            public partial class MortaredStoneFireplaceItem : WorldObjectItem<MortaredStoneFireplaceObject>
    {
        ...
        {
            ObjectName                              = typeof(MortaredStoneFireplaceObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "MortaredStoneFireplace".</para>
    ...
    public partial class MortaredStoneFireplaceRecipe : RecipeFamily
    {
        public MortaredStoneFireplaceRecipe()
        {
            ...
            recipe.Init(
                name: "MortaredStoneFireplace",  //noloc
                displayName: Localizer.DoStr("Mortared Stone Fireplace"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MortaredStoneFireplaceRecipe), start: 10, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Mortared Stone Fireplace"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Mortared Stone Fireplace"), recipeType: typeof(MortaredStoneFireplaceRecipe));
            this.ModsPostInitialize();
