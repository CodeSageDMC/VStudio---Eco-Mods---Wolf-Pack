...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Limestone Wolf Statue Item")]
    ...
    [LocDescription("A wolf statue carved from limestone.")]
    [Ecopedia("Housing Objects", "Outdoor", createAsSubPage: true)]
    [Tag("Housing")]
    [Weight(5000)] // Defines how heavy LimestoneWolfStatue is.
        ...
        public partial class LimestoneWolfStatueItem : WorldObjectItem<LimestoneWolfStatueObject>
    {
        ...
        {
            ObjectName                              = typeof(LimestoneWolfStatueObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "LimestoneWolfStatue".</para>
    ...
    public partial class LimestoneWolfStatueRecipe : RecipeFamily
    {
        public LimestoneWolfStatueRecipe()
        {
            ...
            recipe.Init(
                name: "LimestoneWolfStatue",  //noloc
                displayName: Localizer.DoStr("Limestone Wolf Statue"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LimestoneWolfStatueRecipe), start: 7, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Limestone Wolf Statue"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Limestone Wolf Statue"), recipeType: typeof(LimestoneWolfStatueRecipe));
            this.ModsPostInitialize();
