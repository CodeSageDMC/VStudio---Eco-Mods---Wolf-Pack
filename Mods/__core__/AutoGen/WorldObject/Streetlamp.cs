...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Outdoor", subPageName: "Streetlamp Item")]
            public partial class StreetlampObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(StreetlampItem);
        public override LocString DisplayName => Localizer.DoStr("Streetlamp");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = StreetlampItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy Streetlamp is.
            public partial class StreetlampItem : WorldObjectItem<StreetlampObject>
    {
        ...
        {
            ObjectName                              = typeof(StreetlampObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Streetlamp".</para>
    ...
    public partial class StreetlampRecipe : RecipeFamily
    {
        public StreetlampRecipe()
        {
            ...
            recipe.Init(
                name: "Streetlamp",  //noloc
                displayName: Localizer.DoStr("Streetlamp"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(StreetlampRecipe), start: 6, skillType: typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Streetlamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Streetlamp"), recipeType: typeof(StreetlampRecipe));
            this.ModsPostInitialize();
