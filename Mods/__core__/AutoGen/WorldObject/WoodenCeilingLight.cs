...
namespace Eco.Mods.TechTree
{
            ...
            public partial class WoodenCeilingLightItem : WorldObjectItem<WoodenCeilingLightObject>
    {
        ...
        {
            ObjectName                              = typeof(WoodenCeilingLightObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WoodenCeilingLight".</para>
    ...
    public partial class WoodenCeilingLightRecipe : RecipeFamily
    {
        public WoodenCeilingLightRecipe()
        {
            ...
            recipe.Init(
                name: "WoodenCeilingLight",  //noloc
                displayName: Localizer.DoStr("Wooden Ceiling Light"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(WoodenCeilingLightRecipe), start: 4, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Wooden Ceiling Light"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Wooden Ceiling Light"), recipeType: typeof(WoodenCeilingLightRecipe));
            this.ModsPostInitialize();
