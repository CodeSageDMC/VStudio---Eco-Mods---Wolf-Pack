...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "Drying Rack Item")]
...
//////////////////////////////////////2X3X2//////////////////////////////////////
            ...
            AddOccupancy<DryingRackObject>(BlockOccupancyList);
        }
    ...
    [Weight(1000)] // Defines how heavy DryingRack is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "DryingRack".</para>
    ...
    public partial class DryingRackRecipe : RecipeFamily
    {
        public DryingRackRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<DryingRackItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "DryingRack"
            this.ModsPreInitialize();
