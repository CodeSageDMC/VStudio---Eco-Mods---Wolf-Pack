...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "PowderedSugar" item. 
    ...
    [LocDisplayName("Powdered Sugar")] // Defines the localized name of the item.
    [Weight(300)] // Defines how heavy the PowderedSugar is.

    [Ecopedia("Food", "Produce", createAsSubPage: true)]
    [LocDescription("Powdered Sugar.")] //The tooltip description for the food item.
