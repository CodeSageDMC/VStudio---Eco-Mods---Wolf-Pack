...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "BottledBeer" item. 
    ...
    [LocDisplayName("Bottled Beer")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the BottledBeer is.
    [Ecopedia("Food", "Brewery", createAsSubPage: true)]
    [LocDescription("Bottled Beer.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BottledBeer".</para>
    ...
    public partial class BottledBeerRecipe : RecipeFamily
    {
        public BottledBeerRecipe()
        {
            ...
            //noloc
                ...
                {
                    new CraftingElement<BottledBeerItem>(50),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "BottledBeer"
